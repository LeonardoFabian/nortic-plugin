...
/***/ "./src/blocks/document-explorer/main.css":
/*!***********************************************!*\
  !*** ./src/blocks/document-explorer/main.css ***!
  \***********************************************/
...
/***/ "./src/blocks/document-explorer/block.json":
/*!*************************************************!*\
  !*** ./src/blocks/document-explorer/block.json ***!
  \*************************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"nortic-plugin/document-explorer","title":"Document Explorer","category":"widgets","description":"Add a custom document explorer","keywords":["document","documento","file","item","pdf","txt","doc","docx","xls","xlsx","ppt","pptx","ods","csv","image","audio","video"],"version":"1","textdomain":"nortic-plugin","editorScript":"file:./index.js","attributes":{"parentId":{"type":"number","default":0},"order":{"type":"string","default":"desc"},"orderBy":{"type":"string","default":"date"}},"style":"file:./index.css"}');
...
(() => {
/*!***********************************************!*\
  !*** ./src/blocks/document-explorer/index.js ***!
  \***********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/blocks/document-explorer/block.json");
/* harmony import */ var _icons_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../icons.js */ "./src/icons.js");
/* harmony import */ var _main_css__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./main.css */ "./src/blocks/document-explorer/main.css");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, {
  ...
  edit(_ref) {
    ...
    const allFolders = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(select => {
    ...
    const documents = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(select => {
      return select("core").getEntityRecords("postType", "document", {
        per_page: -1,
        parent: parentId,
        orderby: "title",
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.PanelBody, {
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Document Root", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain)
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.SelectControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Select Root Folder", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain),
      value: parentId,
      options: [{
        value: 0,
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("-- Root --", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain)
    ...
    }))), documents?.length > 0 ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", blockProps, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("ul", {
      className: "document-explorer-list"
    }, (documents || []).map(doc => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(DocumentItem, {
      key: doc.id,
      doc: doc
    })))) : (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("No documents found", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain)));
  },
  save() {
    return null;
  }
});
function DocumentItem(_ref2) {
  let {
    doc
  } = _ref2;
  const meta = doc.meta || {};
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", {
    className: `document-explorer-item ${isFolder ? "folder" : "file"}`
  }, isFolder ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("strong", null, doc.title.rendered) : isLink ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    href: meta.document_external_url,
    target: "_blank",
    rel: "noopener noreferrer"
  }, doc.title.rendered) : isNote ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, meta.note) : isFile ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, doc.title.rendered), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    href: meta.file_url,
    download: true,
    className: "download-button"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Download", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain))) : null);
}
})();
