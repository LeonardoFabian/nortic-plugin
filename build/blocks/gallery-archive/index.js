...
/***/ "./src/blocks/gallery-archive/main.css":
/*!*********************************************!*\
  !*** ./src/blocks/gallery-archive/main.css ***!
  \*********************************************/
...
/***/ "./src/blocks/gallery-archive/block.json":
/*!***********************************************!*\
  !*** ./src/blocks/gallery-archive/block.json ***!
  \***********************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"nortic-plugin/gallery-archive","title":"Gallery Archive","category":"text","description":"Add a list of gallery post type.","keywords":["gallery","archive"],"version":"1","textdomain":"nortic-plugin","editorScript":"file:./index.js","attributes":{"count":{"type":"number","default":9}},"style":"file:./index.css"}');
...
(() => {
/*!*********************************************!*\
  !*** ./src/blocks/gallery-archive/index.js ***!
  \*********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./block.json */ "./src/blocks/gallery-archive/block.json");
/* harmony import */ var _icons_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../icons.js */ "./src/icons.js");
/* harmony import */ var _main_css__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./main.css */ "./src/blocks/gallery-archive/main.css");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_7__.name, {
  ...
  edit(_ref) {
    ...
    const data = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.useSelect)(select => {
    ...
    /* eslint-disable */
    console.log(...oo_oo(`4073991583_28_4_28_21_4`, data));
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelBody, {
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)("Gallery settings", "nortic-plugin")
      ...
      className: "nortic-plugin-gallery-archive-wrapper grid grid-cols-4 md:grid-cols-3 gap-4"
    }, data && data?.map(gallery => {
      const galleryFeaturedImage = gallery._embedded && gallery._embedded["wp:featuredmedia"] && gallery._embedded["wp:featuredmedia"].length > 0 && gallery._embedded["wp:featuredmedia"][0];
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "nortic-plugin-gallery-archive-item"
        ...
        src: galleryFeaturedImage.media_details.sizes.full.source_url,
        alt: galleryFeaturedImage.alt_text
      }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("figcaption", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "flex flex-col items-center justify-center"
      }, gallery.title.rendered && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h3", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
        href: gallery.link
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.RawHTML, null, gallery.title.rendered))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("time", {
        dateTime: (0,_wordpress_date__WEBPACK_IMPORTED_MODULE_5__.format)("c", gallery.date_gmt)
      }, (0,_wordpress_date__WEBPACK_IMPORTED_MODULE_5__.dateI18n)((0,_wordpress_date__WEBPACK_IMPORTED_MODULE_5__.__experimentalGetSettings)().formats.date, gallery.date_gmt))))));
    }))));
  }
});
