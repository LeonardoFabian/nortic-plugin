...
/*!****************************************************************!*\
  !*** ./src/blocks/directories-tab/frontend-directories-tab.js ***!
  \****************************************************************/
__webpack_require__.r(__webpack_exports__);
document.addEventListener("DOMContentLoaded", function () {
  const tabButtons = document.querySelectorAll(".directories-tab-button");
  const tabContents = document.querySelectorAll(".directories-tabs-content-list");
  if (tabButtons.length > 0 && tabContents.length > 0) {
    ...
    tabButtons.forEach(button => {
      button.addEventListener("click", function () {
        ...
        const activeContent = document.querySelector(`.directories-tabs-content-list[data-term-id="${termId}"]`);
        if (activeContent) {
...
/******/ })()
;
//# sourceMappingURL=frontend-directories-tab.js.map