...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"nortic-plugin/banner","title":"Banner","category":"text","description":"Add a custom Banner block","keywords":["banner"],"version":"1","textdomain":"","editorScript":"file:./index.js","attributes":{"title":{"type":"string","source":"html","selector":"h4"},"imageID":{"type":"number","default":0},"imageAlt":{"type":"string","default":""},"imageUrl":{"type":"string","default":"","source":"attribute","selector":"img","attribute":"src"},"objectFit":{"type":"string","default":"contain"},"link":{"type":"string","default":""},"linkTarget":{"type":"string","default":"_self"}},"style":"file:./index.css"}');
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./block.json */ "./src/blocks/banner/block.json");
/* harmony import */ var _icons_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../icons.js */ "./src/icons.js");
/* harmony import */ var _main_css__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./main.css */ "./src/blocks/banner/main.css");
  ...
  edit(_ref) {
    ...
    const handleBannerSelect = img => {
      ...
      if ((0,_wordpress_blob__WEBPACK_IMPORTED_MODULE_4__.isBlobURL)(img.url)) {
        ...
        if (img.sizes) {
          newBannerImageURL = img.sizes.mediumRectangle ? img.sizes.mediumRectangle.url : img.sizes.full.url;
          newBannerImageHeight = img.sizes.mediumRectangle ? img.sizes.mediumRectangle.height : img.sizes.full.height;
        } else {
          newBannerImageURL = img.media_details.sizes.mediumRectangle.source_url;
        ...
        (0,_wordpress_blob__WEBPACK_IMPORTED_MODULE_4__.revokeBlobURL)(bannerImagePreview);
      }
    ...
    const bannerImageObject = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.useSelect)(select => {
      const {
        getMedia
      } = select("core");
    ...
    const bannerImageSizes = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.useSelect)(select => {
      return select(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.store).getSettings().imageSizes;
    });

    /* eslint-disable */
    console.log(...oo_oo(`2410107696_94_4_94_33_4`, bannerImageSizes));
    ...
    const [bannerImagePreview, setBannerImagePreview] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(imageUrl);
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, bannerImagePreview && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.BlockControls, {
      group: "inline"
      ...
      accept: "image/*",
      onError: e => /* eslint-disable */console.error(...oo_tx(`2410107696_136_30_136_46_11`, e)),
    ...
    }, bannerImagePreview && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.SelectControl, {
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)("Object fit", "nortic-plugin"),
      value: objectFit,
      options: [{
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)("Contain", "nortic-plugin"),
        value: "contain"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)("Cover", "nortic-plugin"),
        value: "cover"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)("Fill", "nortic-plugin"),
        value: "fill"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)("Scale Down", "nortic-plugin"),
        value: "scale-down"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)("None", "nortic-plugin"),
        value: "none"
      }],
      onChange: objectFit => setAttributes({
        objectFit
      })
    }), bannerImagePreview && !(0,_wordpress_blob__WEBPACK_IMPORTED_MODULE_4__.isBlobURL)(bannerImagePreview) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.TextareaControl, {
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)("Image link", "nortic-plugin"),
      value: link,
      onChange: link => setAttributes({
        link
      }),
      help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)("Add a link to the banner", "nortic-plugin")
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.SelectControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)("Link target", "nortic-plugin"),
      value: linkTarget,
      options: [{
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)("Same tab", "nortic-plugin"),
        value: "_self"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)("New tab", "nortic-plugin"),
        value: "_blank"
      }],
      onChange: linkTarget => setAttributes({
        linkTarget
      })
    }))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", blockProps, bannerImagePreview && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
      ...
      icon: "format-image",
      onSelect: handleBannerSelect,
      onError: e => /* eslint-disable */console.error(...oo_tx(`2410107696_225_30_225_46_11`, e)),
