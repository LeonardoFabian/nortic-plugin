...
/***/ "./src/blocks/attached-resource/main.css":
/*!***********************************************!*\
  !*** ./src/blocks/attached-resource/main.css ***!
  \***********************************************/
...
/***/ "./src/blocks/attached-resource/block.json":
/*!*************************************************!*\
  !*** ./src/blocks/attached-resource/block.json ***!
  \*************************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"nortic-plugin/attached-resource","title":"Resource","category":"widgets","description":"Attach a resource to your post","keywords":["resource","document","file"],"version":"1","textdomain":"nortic-plugin","editorScript":"file:./index.js","attributes":{"fileID":{"type":"number","default":0},"fileUrl":{"type":"string","default":""},"fileSize":{"type":"string","default":""},"fileName":{"type":"string","default":""},"fileMime":{"type":"string","default":""},"fileSubtype":{"type":"string","default":""},"fileDate":{"type":"string","default":""},"downloadBtnBgColor":{"type":"string","default":"#ee2a24"},"downloadBtnBorderColor":{"type":"string","default":"#ee2a24"},"downloadBtnTextColor":{"type":"string","default":"#ffffff"},"downloadBtnText":{"type":"string","default":"Descargar"},"renderOption":{"type":"string","default":"file"},"title":{"type":"string"}},"style":"file:./index.css","usesContext":["postId"]}');
...
(() => {
/*!***********************************************!*\
  !*** ./src/blocks/attached-resource/index.js ***!
  \***********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block.json */ "./src/blocks/attached-resource/block.json");
/* harmony import */ var _icons_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../icons.js */ "./src/icons.js");
/* harmony import */ var _mimeToIconMap_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../mimeToIconMap.js */ "./src/mimeToIconMap.js");
...
/* harmony import */ var _main_css__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./main.css */ "./src/blocks/attached-resource/main.css");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_4__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_1__.name, {
  icon: _icons_js__WEBPACK_IMPORTED_MODULE_2__["default"].domo,
  edit(_ref) {
    let {
      attributes,
      setAttributes,
    ...
    const ALLOWED_TYPES = ["application/pdf", "application/vnd.ms-powerpoint", "application/vnd.openxmlformats-officedocument.presentationml.presentation", "text/plain", "application/vnd.ms-excel", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "text/csv", "application/msword", "application/vnd.openxmlformats-officedocument.wordprocessingml.document", "audio/mpeg", "video/mp4", "video/mpeg", "application/vnd.oasis.opendocument.spreadsheet", "application/vnd.oasis.opendocument.text", "image/jpeg", "image/png", "image/gif", "image/webp", "image/svg+xml"];
    const handleOnSelect = media => {
      /* eslint-disable */console.log(...oo_oo(`1818257886_76_6_76_47_4`, "Attached Resource: ", media));
      ...
      setAttributes({
        ...
        fileMime: _mimeToIconMap_js__WEBPACK_IMPORTED_MODULE_3__["default"][media?.mime_type] || _mimeToIconMap_js__WEBPACK_IMPORTED_MODULE_3__["default"][media?.mime] || "file",
        fileSubtype: media?.subtype,
        fileDate: media?.dateFormatted
      });
    };
    const handleOnSelectURL = url => {
      /* eslint-disable */console.log(...oo_oo(`1818257886_102_6_102_31_4`, "URL: ", url));
      setAttributes({
        fileID: null,
        fileUrl: url,
        fileSize: null,
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, fileUrl && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_5__.BlockControls, {
      group: "inline"
      ...
      name: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__.__)("Replace", _block_json__WEBPACK_IMPORTED_MODULE_1__.textdomain),
      mediaId: fileID,
      newMediaURL: fileUrl,
    ...
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__.__)("Remove", _block_json__WEBPACK_IMPORTED_MODULE_1__.textdomain))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_5__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_5__.PanelColorSettings, {
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__.__)("Download Button", _block_json__WEBPACK_IMPORTED_MODULE_1__.textdomain),
      colorSettings: [{
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__.__)("Background Color", _block_json__WEBPACK_IMPORTED_MODULE_1__.textdomain),
        value: downloadBtnBgColor,
        onChange: downloadBtnBgColor => setAttributes({
          downloadBtnBgColor
        })
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__.__)("Text Color", _block_json__WEBPACK_IMPORTED_MODULE_1__.textdomain),
        value: downloadBtnTextColor,
        onChange: downloadBtnTextColor => setAttributes({
          downloadBtnTextColor
        })
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__.__)("Border Color", _block_json__WEBPACK_IMPORTED_MODULE_1__.textdomain),
        value: downloadBtnBorderColor,
        onChange: downloadBtnBorderColor => setAttributes({
          downloadBtnBorderColor
        })
      }]
      ...
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__.__)("Show", _block_json__WEBPACK_IMPORTED_MODULE_1__.textdomain)
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__.__)("Title", _block_json__WEBPACK_IMPORTED_MODULE_1__.textdomain),
      value: title,
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__.__)("Display options", _block_json__WEBPACK_IMPORTED_MODULE_1__.textdomain),
      value: renderOption,
      options: [{
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__.__)("Button", _block_json__WEBPACK_IMPORTED_MODULE_1__.textdomain),
        value: "button"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__.__)("File", _block_json__WEBPACK_IMPORTED_MODULE_1__.textdomain),
        value: "file"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__.__)("Link", _block_json__WEBPACK_IMPORTED_MODULE_1__.textdomain),
        value: "link"
      }],
      onChange: renderOption => setAttributes({
        renderOption
      })
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__.__)("Link label", _block_json__WEBPACK_IMPORTED_MODULE_1__.textdomain),
      value: downloadBtnText,
      onChange: downloadBtnText => setAttributes({
        downloadBtnText
      }),
      help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__.__)("Button text", _block_json__WEBPACK_IMPORTED_MODULE_1__.textdomain)
    }))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", blockProps, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_5__.MediaPlaceholder, {
      allowedTypes: ALLOWED_TYPES,
      accept: "application/*, text/*, audio/*, video/*, image/*",
      icon: "upload",
      onSelect: handleOnSelect,
      onError: e => {
        /* eslint-disable */console.error(...oo_tx(`1818257886_202_14_202_30_11`, e));
      },
      disableMediaButtons: fileUrl,
      onSelectURL: handleOnSelectURL
    }), renderOption === "button" && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
      href: fileUrl,
    ...
    }), " ", downloadBtnText), renderOption === "file" && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
      src: `${pluginDirectoryUri}dist/public/images/${fileMime}.svg`,
      alt: title
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, title), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "file-meta divide-x"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
      className: "px-2"
    }, fileSize)))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
      href: fileUrl
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("i", {
      className: "bi bi-download mr-2"
    }), " ", downloadBtnText)), renderOption === "link" && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
      href: fileUrl
  ...
  save(_ref2) {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", blockProps, renderOption === "button" && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
      href: fileUrl,
      className: "attached-resource-download-option inline-block py-4 px-8 gap-4 relative",
      style: {
        color: `${downloadBtnTextColor}`,
