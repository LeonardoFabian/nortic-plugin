...
/***/ "./src/blocks/file-manager/main.css":
/*!******************************************!*\
  !*** ./src/blocks/file-manager/main.css ***!
  \******************************************/
...
/***/ "./src/blocks/file-manager/block.json":
/*!********************************************!*\
  !*** ./src/blocks/file-manager/block.json ***!
  \********************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"nortic-plugin/file-manager","title":"File Manager","category":"text","description":"Add a custom File block","keywords":["document"],"version":"1","textdomain":"nortic-plugin","editorScript":"file:./index.js","attributes":{"title":{"type":"string","source":"html","selector":"h5"},"description":{"type":"string","default":""},"fileID":{"type":"number","default":0},"fileUrl":{"type":"string"},"fileSize":{"type":"number","default":0},"fileImageUrl":{"type":"string"},"downloadBtnColor":{"type":"string","default":"#ee2a24"},"downloadBtnBorderColor":{"type":"string","default":"#ee2a24"},"downloadBtnTextColor":{"type":"string","default":"#ffffff"},"viewBtnColor":{"type":"string","default":"#ffffff;"},"viewBtnBorderColor":{"type":"string","default":"#003876"},"viewBtnTextColor":{"type":"string","default":"#003876"}},"style":"file:./index.css"}');
...
(() => {
/*!******************************************!*\
  !*** ./src/blocks/file-manager/index.js ***!
  \******************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/blocks/file-manager/block.json");
/* harmony import */ var _icons_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../icons.js */ "./src/icons.js");
/* harmony import */ var _main_css__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./main.css */ "./src/blocks/file-manager/main.css");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, {
  ...
  edit(_ref) {
    ...
    const handleFileSelect = file => {
      ...
      if ((0,_wordpress_blob__WEBPACK_IMPORTED_MODULE_4__.isBlobURL)(file.url)) {
        newFileURL = file.url;
      } else {
        newFileURL = file.url;
        ...
        (0,_wordpress_blob__WEBPACK_IMPORTED_MODULE_4__.revokeBlobURL)(fileImagePreview);
      }
    ...
    const [fileImagePreview, setFileImagePreview] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(fileImageUrl);
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, fileImageUrl && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.BlockControls, {
      group: "inline"
      ...
      name: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Replace File", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain),
      mediaId: fileID,
      mediaURL: fileUrl,
      allowedTypes: ["application/pdf", "application/vnd.ms-powerpoint", "application/vnd.openxmlformats-officedocument.presentationml.presentation", "text/plain", "application/vnd.ms-excel", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "text/csv", "application/msword", "application/vnd.openxmlformats-officedocument.wordprocessingml.document", "audio/mpeg", "video/mp4", "video/mpeg", "application/vnd.oasis.opendocument.spreadsheet", "application/vnd.oasis.opendocument.text"],
      accept: "application/*, text/*, audio/*, video/*, image/*",
      onError: e => /* eslint-disable */console.error(...oo_tx(`1688189810_143_30_143_46_11`, e)),
    ...
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Remove file", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.PanelColorSettings, {
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Download Button", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain),
      colorSettings: [{
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Background Color", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain),
        value: downloadBtnColor,
        onChange: downloadBtnColor => setAttributes({
          downloadBtnColor
        })
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Text Color", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain),
        value: downloadBtnTextColor,
        onChange: downloadBtnTextColor => setAttributes({
          downloadBtnTextColor
        })
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Border Color", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain),
    ...
    }, fileUrl && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.TextareaControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Description", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain),
      value: description,
      onChange: description => setAttributes({
        description
      }),
      help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Add a File description", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain)
      ...
      className: "file-options flex justify-between items-center px-4 pt-4"
      ...
      className: "sr-only"
    }, "Open dropdown"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("i", {
    ...
    }, "Edit")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
      href: "#",
      className: "block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white"
    }, "Export Data")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
      href: "#",
      className: "block px-4 py-2 text-sm text-red-600 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white"
    }, "Delete"))))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "file-meta flex flex-col items-center pb-4 px-6"
    }, fileUrl && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
      className: "h-16 mb-6",
      src: fileImagePreview,
      alt: "Bonnie image"
    }), (0,_wordpress_blob__WEBPACK_IMPORTED_MODULE_4__.isBlobURL)(fileUrl) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Spinner, null), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      onSelect: handleFileSelect,
      onError: e => {
        /* eslint-disable */console.error(...oo_tx(`1688189810_285_18_285_34_11`, e));
      },
      ...
      placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("File Title", "nortic-plugin"),
      value: title,
    ...
    }, fileSize), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "flex justify-center mt-4 gap-x-2 md:mt-6"
    ...
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("View", "nortic-plugin")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
      href: fileUrl,
      download: true,
    ...
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Download", "nortic-plugin"))))));
  },
  save(_ref2) {
    let {
      attributes
