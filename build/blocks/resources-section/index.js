...
/***/ "./src/blocks/resources-section/main.css":
/*!***********************************************!*\
  !*** ./src/blocks/resources-section/main.css ***!
  \***********************************************/
...
/***/ "./src/blocks/resources-section/block.json":
/*!*************************************************!*\
  !*** ./src/blocks/resources-section/block.json ***!
  \*************************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"nortic-plugin/resources-section","title":"Resources Section","category":"text","description":"A list of resources","keywords":["resources","resources section","recursos"],"version":"1","textdomain":"nortic-plugin","editorScript":"file:./index.js","attributes":{"heading":{"type":"string","default":""},"subheading":{"type":"string","default":""},"columns":{"type":"number","default":3},"taxonomy":{"type":"string","default":""},"terms":{"type":"array","default":[]},"count":{"type":"number","default":10},"order":{"type":"string","default":"desc"},"orderBy":{"type":"string","default":"date"}},"style":"file:./index.css","script":"file:./resources-section.js"}');
...
(() => {
/*!***********************************************!*\
  !*** ./src/blocks/resources-section/index.js ***!
  \***********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block.json */ "./src/blocks/resources-section/block.json");
/* harmony import */ var _icons_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../icons.js */ "./src/icons.js");
/* harmony import */ var _main_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./main.css */ "./src/blocks/resources-section/main.css");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_4__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_1__.name, {
  ...
  edit(_ref) {
    ...
    const resources = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_7__.useSelect)(select => {
      return select("core").getEntityRecords("postType", "resource", {
        per_page: count,
        _embed: true,
        order: order,
        orderby: orderBy
    ...
    /* eslint-disable */
    console.log(...oo_oo(`2758212875_34_4_34_41_4`, "Resources: ", resources));
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("section", blockProps, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__.__)("Click to add a heading", _block_json__WEBPACK_IMPORTED_MODULE_1__.textdomain),
      value: heading,
      ...
      tagName: "h4",
      className: "resources-section-subheading",
      placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__.__)("Click to add a subheading", _block_json__WEBPACK_IMPORTED_MODULE_1__.textdomain),
      value: subheading,
      ...
      className: "resources-section-content-wrapper",
      "data-glide-el": "track"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("ul", {
      class: "glide__slides"
    }, (resources || []).map(resource => {
      const featuredImage = resource?._embedded && resource?._embedded["wp:featuredmedia"] && resource?._embedded["wp:featuredmedia"].length > 0 && resource?._embedded["wp:featuredmedia"][0];
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", {
        className: "max-w-sm bg-white shadow flex flex-col justify-between"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "text-center mb-6"
      }, featuredImage?.media_details?.sizes?.full && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "service-card-image-wrapper text-center mb-6 h-[50px]"
      ...
      }, resource?.title?.rendered)), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "flex items-center justify-center"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
        href: "#",
        className: "inline-flex font-medium items-center text-blue-600 hover:underline"
      }, "Ver m\xE1s", (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("svg", {
