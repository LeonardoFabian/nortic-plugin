...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"nortic-plugin/slide","title":"Slide","category":"text","description":"Add an slide to slideshow block","keywords":["slide"],"version":"1","textdomain":"","editorScript":"file:./index.js","attributes":{"title":{"type":"string","default":""},"titleColor":{"type":"string","default":"#FFFFFF"},"subTitle":{"type":"string","default":""},"subTitleColor":{"type":"string","default":"#FFFFFF"},"imageID":{"type":"number","default":0},"imageUrl":{"type":"string","default":""},"imageAlt":{"type":"string","default":""},"showTitle":{"type":"boolean","default":true},"showSubTitle":{"type":"boolean","default":true},"buttonLabel":{"type":"string","default":"Leer más"},"buttonUrl":{"type":"string","default":"#"},"buttonColor":{"type":"string","default":"#003876"},"showButton":{"type":"boolean","default":true}},"style":"file:./index.css"}');
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/blocks/slide/block.json");
/* harmony import */ var _icons_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../icons.js */ "./src/icons.js");
/* harmony import */ var _main_css__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./main.css */ "./src/blocks/slide/main.css");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, {
  ...
  edit(_ref) {
    ...
    const handleHeroBlankImageSelect = image => {
      ...
      if ((0,_wordpress_blob__WEBPACK_IMPORTED_MODULE_3__.isBlobURL)(image.url)) {
        ...
        newHeroBlankImageURL = image.sizes ? image.sizes.bannerHero.url : image.media_details.sizes.bannerHero.source_url;
        setAttributes({
          imageID: image.id,
        ...
        (0,_wordpress_blob__WEBPACK_IMPORTED_MODULE_3__.revokeBlobURL)(heroBlankImagePreview);
      }
    ...
    const [heroBlankImagePreview, setHeroBlankImagePreview] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(imageUrl);
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, heroBlankImagePreview && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.BlockControls, {
      group: "inline"
      ...
      accept: "image/*",
      onError: e => /* eslint-disable */console.error(...oo_tx(`392044964_93_30_93_46_11`, e)),
    ...
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Remove image", "nortic-plugin"))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.PanelBody, {
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Title", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain),
      value: title,
      onChange: title => setAttributes({
        title
      })
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.ToggleControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Show title", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain),
      checked: showTitle,
      onChange: showTitle => setAttributes({
        showTitle
      })
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.TextControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Sub title", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain),
      value: subTitle,
      onChange: subTitle => setAttributes({
        subTitle
      })
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.ToggleControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Show sub title", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain),
      checked: showSubTitle,
      onChange: showSubTitle => setAttributes({
        showSubTitle
      })
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.ToggleControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Show button", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain),
      checked: showButton,
      onChange: showButton => setAttributes({
        showButton
      })
    }), showButton && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.TextControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Button label", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain),
      value: buttonLabel,
      onChange: buttonLabel => setAttributes({
        buttonLabel
      })
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.TextControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Button url", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain),
      value: buttonUrl,
      ...
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Colors", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain),
      initialOpen: true,
      colorSettings: [{
        value: titleColor,
        ...
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Title color", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain)
      }, {
        value: subTitleColor,
        onChange: newColor => setAttributes({
          subTitleColor: newColor
        }),
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Sub title color", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain)
      }, {
        value: buttonColor,
        onChange: newColor => setAttributes({
          buttonColor: newColor
        }),
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Button color", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain)
      }]
    })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", blockProps, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "slide_bg-image-container"
    }, (0,_wordpress_blob__WEBPACK_IMPORTED_MODULE_3__.isBlobURL)(imageUrl) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.Spinner, null), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.MediaPlaceholder, {
      allowedTypes: ["image/png", "image/jpeg"],
      accept: "image/*",
      icon: "format-image",
      onSelect: handleHeroBlankImageSelect,
      onError: e => /* eslint-disable */console.error(...oo_tx(`392044964_186_30_186_46_11`, e)),
    ...
    }, showTitle && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h2", {
      className: "slide_title  text-2xl font-bold",
      style: {
        color: titleColor
      }
    }, title), showSubTitle && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
      className: "slide_sub-title text-lg",
      style: {
        color: subTitleColor
      }
    }, subTitle), showButton && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
      href: buttonUrl,
  ...
  save(_ref2) {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", blockProps, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "slide_bg-image-container"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
      className: "slide_bg-image",
      src: imageUrl,
      ...
      className: "slide_content"
    }, showTitle && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h1", {
      className: "slide_title text-2xl font-bold",
      style: {
        color: titleColor
      }
