...
(() => {
/*!*********************************************************!*\
  !*** ./src/blocks/services-section/services-section.js ***!
  \*********************************************************/
__webpack_require__.r(__webpack_exports__);
    ...
    mount() {
      ...
      Glide.on(["mount.after", "run"], () => {
        for (let controlItem of Components.Controls.items) {
          ...
          if (right) {
            const lastSlideIndex = Glide.settings.bound ? Glide.index + (Glide.settings.perView - 1) : Glide.index;
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (serviceSection) {
    var glide = new _glidejs_glide__WEBPACK_IMPORTED_MODULE_0__["default"](serviceSection, {
      type: "carousel",
      startAt: 0,
      autoplay: 3000,
      gap: 10,
...
/******/ })()
;
//# sourceMappingURL=services-section.js.map