...
/***/ "./src/blocks/service-card/main.css":
/*!******************************************!*\
  !*** ./src/blocks/service-card/main.css ***!
  \******************************************/
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"nortic-plugin/service-card","title":"Service Card","category":"text","description":"Show details of a service on a card","keywords":["servicio","service","summary","detalles","details","service card"],"version":"1","textdomain":"nortic-plugin","editorScript":"file:./index.js","attributes":{"useIcon":{"type":"boolean","default":false},"icon":{"type":"string","default":"admin-generic"},"iconColor":{"type":"string","default":"#ee2a24"},"imageId":{"type":"number","default":0},"imageAlt":{"type":"string","default":""},"imageUrl":{"type":"string","default":""},"title":{"type":"string","default":""},"description":{"type":"string","default":""},"bgColor":{"type":"string","default":"#ffffff"},"textColor":{"type":"string","default":"#000000"}},"style":"file:./index.css"}');
...
/* harmony import */ var _main_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./main.css */ "./src/blocks/service-card/main.css");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_5__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_1__.name, {
  ...
  edit(_ref) {
    ...
    const [imagePreview, setImagePreview] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(imageUrl);

    // handle select image
    const handleSelectImage = async image => {
      /* eslint-disable */console.log(...oo_oo(`1677578515_58_6_58_44_4`, "Image selected: ", image));
      let newImageUrl = null;
      if ((0,_wordpress_blob__WEBPACK_IMPORTED_MODULE_7__.isBlobURL)(image?.url)) {
        newImageUrl = await image.url;
      } else {
        newImageUrl = (await image.sizes) ? image.sizes.full.url : image.media_details.sizes.full.source_url;
        setAttributes({
          imageId: image.id,
          imageAlt: image.alt,
          imageUrl: newImageUrl
        });
        (0,_wordpress_blob__WEBPACK_IMPORTED_MODULE_7__.revokeBlobURL)(imagePreview);
      }
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, imagePreview && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_6__.BlockControls, {
      group: "inline"
      ...
      name: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Replace image", _block_json__WEBPACK_IMPORTED_MODULE_1__.textdomain),
      mediaId: imageId,
      mediaURL: imageUrl,
    ...
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Remove image", _block_json__WEBPACK_IMPORTED_MODULE_1__.textdomain))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_6__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_8__.PanelBody, {
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Settings", _block_json__WEBPACK_IMPORTED_MODULE_1__.textdomain)
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Title", _block_json__WEBPACK_IMPORTED_MODULE_1__.textdomain),
      value: title,
      onChange: title => setAttributes({
        title
      })
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_8__.TextareaControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Description", _block_json__WEBPACK_IMPORTED_MODULE_1__.textdomain),
      value: description,
    ...
    }, useIcon ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "service-card-image-wrapper text-center h-24"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_8__.Dashicon, {
      icon: icon,
      style: {
        color: "#ee2a24"
      }
      ...
      className: "service-card-image-wrapper text-center h-24"
    }, imagePreview && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
      src: imageUrl,
      alt: imageAlt,
      className: "h-full object-contain"
    }), (0,_wordpress_blob__WEBPACK_IMPORTED_MODULE_7__.isBlobURL)(imageUrl) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_8__.Spinner, null), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_6__.MediaPlaceholder, {
      allowedTypes: ["image/png", "image/jpeg", "image/webp"],
      accept: "image/*",
      icon: "format-image",
      onSelect: handleSelectImage,
      onSelectURL: handleSelectImageFromUrl,
      onError: e => {
        /* eslint-disable */console.error(...oo_tx(`1677578515_152_20_152_63_11`, "Error on select image: ", e));
      },
      ...
      placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Click to add a title", _block_json__WEBPACK_IMPORTED_MODULE_1__.textdomain),
      value: title,
      onChange: title => setAttributes({
        title
      }),
      ...
      placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Click to add a description", _block_json__WEBPACK_IMPORTED_MODULE_1__.textdomain),
      value: description,
      onChange: description => setAttributes({
        description
      }),
