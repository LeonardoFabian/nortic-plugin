...
/***/ "./src/blocks/toggle-menu/main.css":
/*!*****************************************!*\
  !*** ./src/blocks/toggle-menu/main.css ***!
  \*****************************************/
...
/***/ "./src/blocks/toggle-menu/block.json":
/*!*******************************************!*\
  !*** ./src/blocks/toggle-menu/block.json ***!
  \*******************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"nortic-plugin/toggle-menu","title":"Toggle Menu","category":"text","description":"Add a custom toggle menu","keywords":["toggle","menu"],"version":"1","textdomain":"nortic-plugin","editorScript":"file:./index.js","attributes":{"title":{"type":"string","default":""},"color":{"type":"string","default":"#003876"},"background_color":{"type":"string","default":"#FFFFFF"},"menu_icon":{"type":"string","default":"menu-grid-r"},"menu_icon_url":{"type":"string","default":"https://mt.gob.do/images/svg/icons/menu-grid-r.svg"},"menu_position":{"type":"string","default":"absolute"},"transition_direction":{"type":"string","default":"top-sheet"},"visibility":{"type":"string","default":"block"},"display":{"type":"string","default":"grid"},"columns":{"type":"number","default":3}},"style":"file:./index.css","script":"file:./frontend-toggle-menu.js"}');
...
(() => {
/*!*****************************************!*\
  !*** ./src/blocks/toggle-menu/index.js ***!
  \*****************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./block.json */ "./src/blocks/toggle-menu/block.json");
/* harmony import */ var _icons_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../icons.js */ "./src/icons.js");
/* harmony import */ var _main_css__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./main.css */ "./src/blocks/toggle-menu/main.css");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_5__.name, {
  ...
  edit(_ref) {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.PanelColorSettings, {
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__._x)("Visibility", "SelectControl label", "nortic-plugin"),
      value: visibility,
      options: [{
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Desktop and Mobile"),
        value: "block"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Desktop only"),
        value: "hidden lg:block"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Mobile only"),
        value: "block lg:hidden"
      }, {
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__._x)("Display", "SelectControl label", "nortic-plugin"),
      value: display,
      options: [{
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Inline"),
        value: "inline"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Block"),
        value: "block"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Grid"),
        value: "grid"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("List"),
        value: "list-item"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("None"),
        value: "hidden"
    ...
    }), display === "grid" && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.RangeControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Columns", "nortic-plugin"),
      onChange: handleNumberOfColumns,
      value: columns,
      min: 2,
      max: 4
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.SelectControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__._x)("Menu icon", "SelectControl label", "nortic-plugin"),
      value: menu_icon,
      options: [{
    ...
    }), menu_icon ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.__experimentalHStack, {
      alignment: "center",
      style: {
    ...
    })) : null)), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", blockProps, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "menu-toggle"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "menu-toggle-header py-4 cursor-pointer"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
      className: "menu-toggle-button flex items-center"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      className: "px-2 font-medium flex items-center"
      ...
      className: "accordion-icon faq-icon bi bi-plus-lg color-blue text-xl font-semibold"
    })))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: `menu-toggle-content accordion-body overflow-hidden ${display} ${display === "grid" ? "grid-cols-" + columns : ""} justify-items-center content-start transition-all duration-200 ease-out divide-y`
  ...
  save(_ref2) {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", blockProps, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "menu-toggle"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "menu-toggle-header py-4 cursor-pointer"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
