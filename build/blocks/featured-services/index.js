...
/***/ "./src/blocks/featured-services/main.css":
/*!***********************************************!*\
  !*** ./src/blocks/featured-services/main.css ***!
  \***********************************************/
...
/***/ "./src/blocks/featured-services/block.json":
/*!*************************************************!*\
  !*** ./src/blocks/featured-services/block.json ***!
  \*************************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"nortic-plugin/featured-services","title":"Featured Services","category":"text","description":"Add a list of top rated services","keywords":["services"],"version":"1","textdomain":"nortic-plugin","editorScript":"file:./index.js","attributes":{"title":{"type":"string","default":""},"description":{"type":"string","default":""},"count":{"type":"number","default":3},"classifications":{"type":"array","default":[]},"alignment":{"type":"string","default":"center"},"icon":{"type":"string","default":"briefcase"},"icon_color":{"type":"string","default":"#EE2A24"},"shadow":{"type":"boolean","default":false},"text_color":{"type":"string","default":"#003876"}},"style":"file:./index.css","script":"file:./frontend-featured-services.js"}');
...
(() => {
/*!***********************************************!*\
  !*** ./src/blocks/featured-services/index.js ***!
  \***********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./block.json */ "./src/blocks/featured-services/block.json");
/* harmony import */ var _icons_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../icons.js */ "./src/icons.js");
/* harmony import */ var _main_css__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./main.css */ "./src/blocks/featured-services/main.css");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_7__.name, {
  ...
  edit(_ref) {
    ...
    const cardStyle = `col-${count} relative rounded-xl border border-gray-100 p-8 ${shadow == true ? "has-shadow" : ""}`;
    const serviceClassificationsTerms = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.useSelect)(select => {
      return select("core").getEntityRecords("taxonomy", "service_classification", {
        per_page: -1
      });
    }, []);
    ...
    const services = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.useSelect)(select => {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.BlockControls, {
      ...
      controls: [{
        icon: "admin-page",
        title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Shadow", "nortic-plugin"),
      ...
      onCategoryChange: newTerms => {
        ...
        newTerms.forEach(classification => {
          ...
          const classificationTerm = serviceClassificationsTerms?.find(term => term.name === classification);
          if (classificationTerm) newClassifications.push(classificationTerm);
        });
        setAttributes({
      ...
      value: icon,
      options: [{
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Briefcase"),
        value: "briefcase"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Bank"),
        value: "bank"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Bank 2"),
        value: "bank2"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Bar Chart"),
        value: "bar-chart"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Book"),
        value: "book"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Box Seam"),
        value: "box-seam"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Building"),
        value: "building"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Calculator"),
        value: "calculator"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Calendar Week"),
        value: "calendar2-week"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Clock"),
        value: "clock"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Database Lock"),
        value: "database-lock"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Exclamation Circle"),
        value: "exclamation-circle"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Eye"),
        value: "eye"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("File Text"),
        value: "file-text"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Fingerprint"),
        value: "fingerprint"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Flag"),
        value: "flag"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Folder Open"),
        value: "folder2-open"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Gear"),
        value: "gear"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Geo Alt"),
        value: "geo-alt"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Globe"),
        value: "globe"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Graph Up Arrow"),
        value: "graph-up-arrow"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Grid"),
        value: "grid"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Hand Thumbs Up"),
        value: "hand-thumbs-up"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Headset"),
        value: "headset"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Heart Pulse"),
        value: "heart-pulse"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Hourglass"),
        value: "hourglass"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("House"),
        value: "house"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Info Circle"),
        value: "info-circle"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Life Preserver"),
        value: "life-preserver"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Lightning Charge"),
        value: "lightning-charge"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Lock"),
        value: "lock"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Mortarboard"),
        value: "mortarboard"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("People"),
        value: "people"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Person"),
        value: "person"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Puzzle"),
        value: "puzzle"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Question Circle"),
        value: "question-circle"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Search"),
        value: "search"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Share"),
        value: "share"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Shield Check"),
        value: "shield-check"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Shop"),
        value: "shop"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Signpost 2"),
        value: "signpost-2"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Sliders"),
        value: "sliders"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Star"),
        value: "star"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Stopwatch"),
        value: "stopwatch"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Ticket Perforated"),
        value: "ticket-perforated"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Tools"),
        value: "tools"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Trophy"),
        value: "trophy"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Truck"),
        value: "truck"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Umbrella"),
        value: "umbrella"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Vector Pen"),
        value: "vector-pen"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Wallet 2"),
        value: "wallet2"
      }],
      ...
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Colors", "nortic-plugin"),
      colorSettings: [{
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Text color", "nortic-plugin"),
        value: text_color,
        onChange: text_color => setAttributes({
          text_color
        })
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Icon color", "nortic-plugin"),
        value: icon_color,
        onChange: icon_color => setAttributes({
          icon_color
        })
      }]
      ...
      placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Add a title", "nortic-plugin")
    })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "text-center mx-auto"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
      tagName: "p",
      ...
      placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Add description", "nortic-plugin")
    })))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "flex flex-wrap -mx-4 featured-services-container"
      ...
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
        ...
        className: "featured-service-rating rounded-full bg-green-100 px-3 py-1.5 text-xs font-medium text-green-600"
      }, service.meta.rating)), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.RawHTML, null, service.title.rendered)), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
        className: "mt-2 text-md"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.RawHTML, null, service.excerpt.rendered))));
    }))))));
  }
});
})();
