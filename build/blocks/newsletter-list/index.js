...
/***/ "./src/blocks/newsletter-list/main.css":
/*!*********************************************!*\
  !*** ./src/blocks/newsletter-list/main.css ***!
  \*********************************************/
...
/***/ "./src/blocks/newsletter-list/block.json":
/*!***********************************************!*\
  !*** ./src/blocks/newsletter-list/block.json ***!
  \***********************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"nortic-plugin/newsletter-list","title":"Newsletter List","category":"text","description":"Add a list of newsletters","keywords":["newsletters","list"],"version":"1","textdomain":"nortic-plugin","editorScript":"file:./index.js","attributes":{"title":{"type":"string","default":""},"columns":{"type":"number","default":4},"itemsPerPage":{"type":"number","default":100},"newsletterCategories":{"type":"array","default":[]},"order":{"type":"string","default":"desc"},"orderBy":{"type":"string","default":"date"}},"style":"file:./index.css"}');
...
(() => {
/*!*********************************************!*\
  !*** ./src/blocks/newsletter-list/index.js ***!
  \*********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./block.json */ "./src/blocks/newsletter-list/block.json");
/* harmony import */ var _icons_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../icons.js */ "./src/icons.js");
/* harmony import */ var _main_css__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./main.css */ "./src/blocks/newsletter-list/main.css");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_7__.name, {
  ...
  edit(_ref) {
    ...
    const newsletterCategoriesTerms = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.useSelect)(select => {
      return select("core").getEntityRecords("taxonomy", "newsletter_category", {
        per_page: -1
      });
    }, []);
    ...
    const newsletters = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.useSelect)(select => {
    ...
    }, [itemsPerPage, newsletterCategoryIDs, order, orderBy, newsletterCategories]);
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.PanelBody, {
      ...
      minItems: -1,
      maxItems: 200,
      onNumberOfItemsChange: itemsPerPage => setAttributes({
        itemsPerPage
      }),
      ...
      onCategoryChange: newTerms => {
        ...
        newTerms.forEach(cat => {
          ...
          const categoryTerm = newsletterCategoriesTerms?.find(term => term.name === cat);
          if (categoryTerm) newCategories.push(categoryTerm);
        });
        setAttributes({
          newsletterCategories: newCategories
        });
      },
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Columns", _block_json__WEBPACK_IMPORTED_MODULE_7__.textdomain),
      ...
      min: 1,
      max: 5,
      help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Number of columns in which the newsletters will be displayed", _block_json__WEBPACK_IMPORTED_MODULE_7__.textdomain)
      ...
      className: "wp-block-nortic-plugin-nortic-newsletter-list-container"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "wp-block-nortic-plugin-nortic-newsletter-list-header"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
      tagName: "h5",
      placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Click to add a title", _block_json__WEBPACK_IMPORTED_MODULE_7__.textdomain),
      value: title,
      ...
      className: "wp-block-nortic-plugin-nortic-newsletter-list-wrapper"
    }, newsletters?.map(newsletter => {
      const featuredImage = newsletter._embedded && newsletter._embedded["wp:featuredmedia"] && newsletter._embedded["wp:featuredmedia"].length > 0 && newsletter._embedded["wp:featuredmedia"][0];
      {
      ...
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", {
        ...
        className: "newsletter-list-item-img-container"
      }, featuredImage && featuredImage.media_details.sizes.landscape && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
        src: featuredImage.media_details.sizes.landscape.source_url,
        alt: featuredImage?.alt_text,
        className: "newsletter-list-item-img"
      }))), newsletter.title.rendered && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h6", {
        className: "newsletter-title"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.RawHTML, null, newsletter.title.rendered))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "newsletter-meta"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
        className: "newsletter-category-name"
      }, "Category name"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
        className: "newsletter-dependency-name"
      }, "Dependency name")));
    })))));
  }
});
