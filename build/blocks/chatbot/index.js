...
/***/ "./src/blocks/chatbot/block.json":
/*!***************************************!*\
  !*** ./src/blocks/chatbot/block.json ***!
  \***************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"nortic-plugin/chatbot","title":"ChatBot","category":"text","description":"Add a custom chatbot","keywords":["chat","chatbot","chatgpt"],"version":"1","textdomain":"nortic-plugin","editorScript":"file:./index.js","attributes":{},"style":"file:./index.css","script":"file:./frontend-chatbot.js"}');
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/blocks/chatbot/block.json");
/* harmony import */ var _icons_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../icons.js */ "./src/icons.js");
/* harmony import */ var _main_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./main.css */ "./src/blocks/chatbot/main.css");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_4__.name, {
  ...
  edit(_ref) {
    ...
    const blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useBlockProps)({
      className: "chat w-96 container mx-auto flex flex-col justify-end items-center"
    });
    const [messages, setMessages] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)([]);
    const chatRef = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
    (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
      //   console.log("Messages changed");
      chatRef.current.scrollTo(0, chatRef.current.scrollHeight);
    }, [messages]);
    const [promptInput, setPromptInput] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)();
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", blockProps, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "hidden chatbot-container w-full rounded-lg shadow-lg p-4"
      ...
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        ...
        className: "user-avatar rounded-full bg-gray-500 py-2 px-3 mr-4"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("i", {
        className: `bi ${message.avatar}`
      })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "user-message w-full text-sm"
      }, message.text)), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("time", {
        className: "chat-message-time"
      }, message.message_date));
    })), promptInput, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      className: "relative w-full flex items-center justify-end mt-4"
      ...
      className: "bi bi-robot text-4xl text-white"
    }))));
  }
});
})();
