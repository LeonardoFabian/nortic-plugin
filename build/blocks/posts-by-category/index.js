...
/***/ "./src/blocks/posts-by-category/main.css":
/*!***********************************************!*\
  !*** ./src/blocks/posts-by-category/main.css ***!
  \***********************************************/
...
/***/ "./src/blocks/posts-by-category/block.json":
/*!*************************************************!*\
  !*** ./src/blocks/posts-by-category/block.json ***!
  \*************************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"nortic-plugin/nortic-posts-by-category","title":"Posts by Category","category":"widgets","description":"Add a list of posts filtered by category","keywords":["posts","post","noticias","category","categories"],"version":"1","textdomain":"nortic-plugin","editorScript":"file:./index.js","attributes":{"count":{"type":"number","default":5},"categories":{"type":"array","default":[]},"order":{"type":"string","default":"desc"},"orderBy":{"type":"string","default":"date"},"useTemplateQuery":{"type":"boolean","default":false}},"style":"file:./index.css"}');
...
(() => {
/*!***********************************************!*\
  !*** ./src/blocks/posts-by-category/index.js ***!
  \***********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./block.json */ "./src/blocks/posts-by-category/block.json");
/* harmony import */ var _icons_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../icons.js */ "./src/icons.js");
/* harmony import */ var _main_css__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./main.css */ "./src/blocks/posts-by-category/main.css");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_7__.name, {
  ...
  edit(_ref) {
    ...
    const postCategories = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.useSelect)(select => {
      return select("core").getEntityRecords("taxonomy", "category", postCategoriesObj);
    }, []);
    ...
    const handleCategoryChange = cats => {
      ...
      cats?.forEach(cat => {
        ...
        const postCategory = postCategories?.find(postCatgoryObj => postCatgoryObj.name === cat);
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.PanelBody, {
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Settings", _block_json__WEBPACK_IMPORTED_MODULE_7__.textdomain)
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.ToggleControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__._x)("Inherit the template query", "ToggleControl label", _block_json__WEBPACK_IMPORTED_MODULE_7__.textdomain),
      checked: useTemplateQuery,
      onChange: handleUseTemplateQuery,
      help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Toggle using the global query context that is set with the current template, such as a file or a search. Turn it off to customize settings independently.", _block_json__WEBPACK_IMPORTED_MODULE_7__.textdomain)
    ...
    }))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", blockProps, !!categories && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "posts-by-category-header"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("ul", null, categories?.map(category => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
      href: "#"
    }, category?.value)))))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "posts-by-category-wrapper"
    }, posts?.map((post, i) => {
      /* eslint-disable */console.log(...oo_oo(`2344212725_151_14_151_53_4`, "Post by category: ", post));
      ...
      const featuredMedia = post._embedded && post._embedded["wp:featuredmedia"] && post._embedded["wp:featuredmedia"].length > 0 && post._embedded["wp:featuredmedia"][0];
      const featuredMediaAltText = featuredMedia?.alt_text ? featuredMedia.alt_text : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Post featured media", _block_json__WEBPACK_IMPORTED_MODULE_7__.textdomain);

      // using wordpress format for dates
      const date = (0,_wordpress_date__WEBPACK_IMPORTED_MODULE_6__.dateI18n)((0,_wordpress_date__WEBPACK_IMPORTED_MODULE_6__.__experimentalGetSettings)().formats.date, post.date_gmt);
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        key: post.id,
        className: `post-by-category-item post-by-category-item-${i}`
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "post-by-category-image-wrapper"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
        src: featuredMedia?.media_details?.sizes?.full?.source_url,
        alt: featuredMediaAltText
      })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "post-by-category-data"
      }, post?.title?.rendered && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h6", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
        href: post.link
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.RawHTML, null, truncatedTitle))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "post-by-category-metadata"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("time", {
        dateTime: (0,_wordpress_date__WEBPACK_IMPORTED_MODULE_6__.format)("c", post.date_gmt),
        className: "post-by-category-date"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("i", {
        class: "bi bi-calendar4-week"
      }), " ", (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, date))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "post-by-category-excerpt"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.RawHTML, null, truncatedExcerpt)))));
    }))));
  }
});
