...
/***/ "./src/blocks/page-options/main.css":
/*!******************************************!*\
  !*** ./src/blocks/page-options/main.css ***!
  \******************************************/
...
/***/ "./src/blocks/page-options/block.json":
/*!********************************************!*\
  !*** ./src/blocks/page-options/block.json ***!
  \********************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"nortic-plugin/page-options","title":"Page Options","category":"text","description":"Add actions on each of the pages","keywords":["print","export","send","email","pdf"],"version":"1","textdomain":"nortic-plugin","editorScript":"file:./index.js","attributes":{"justify_content":{"type":"string","default":"flex-end"},"show_export_option":{"type":"boolean","default":false},"show_print_option":{"type":"boolean","default":true},"show_send_option":{"type":"boolean","default":true}},"style":"file:./index.css","usesContext":["postId"]}');
...
(() => {
/*!******************************************!*\
  !*** ./src/blocks/page-options/index.js ***!
  \******************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./block.json */ "./src/blocks/page-options/block.json");
/* harmony import */ var _icons_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../icons.js */ "./src/icons.js");
/* harmony import */ var _main_css__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./main.css */ "./src/blocks/page-options/main.css");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_5__.name, {
  ...
  edit(_ref) {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelBody, {
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__._x)("Justify Content", "SelectControl label", "nortic-plugin"),
      value: justify_content,
      options: [{
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__._x)("Normal", "SelectControl label", "nortic-plugin"),
        value: "normal"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__._x)("Start", "SelectControl label", "nortic-plugin"),
        value: "flex-start"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__._x)("End", "SelectControl label", "nortic-plugin"),
        value: "flex-end"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__._x)("Center", "SelectControl label", "nortic-plugin"),
        value: "center"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__._x)("Between", "SelectControl label", "nortic-plugin"),
        value: "space-between"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__._x)("Around", "SelectControl label", "nortic-plugin"),
        value: "space-around"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__._x)("Evenly", "SelectControl label", "nortic-plugin"),
        value: "space-evenly"
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__._x)("Stretch", "SelectControl label", "nortic-plugin"),
        value: "stretch"
      }],
      onChange: handleContentAlignment
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.ToggleControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__._x)("Show print option", "ToggleControl label", _block_json__WEBPACK_IMPORTED_MODULE_5__.textdomain),
      checked: show_print_option,
      onChange: show_print_option => setAttributes({
        show_print_option
      }),
      help: show_print_option ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Print option shown", "nortic-plugin") : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Hidden print option", "nortic-plugin")
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.ToggleControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__._x)("Show export option", "ToggleControl label", "nortic-plugin"),
      checked: show_export_option,
      onChange: show_export_option => setAttributes({
        show_export_option
      }),
      help: show_export_option ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Export option shown", "nortic-plugin") : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Hidden export option", "nortic-plugin")
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.ToggleControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__._x)("Show send option", "ToggleControl label", "nortic-plugin"),
      checked: show_send_option,
      onChange: show_send_option => setAttributes({
        show_send_option
      }),
      help: show_send_option ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Send option shown", "nortic-plugin") : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Hidden send option", "nortic-plugin")
      ...
      className: "sr-only"
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__._x)("Print", "SelectControl label", "nortic-plugin"))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
      type: "button",
      className: "text-blue-700 border border-blue-700 hover:bg-blue-700 hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center mr-2 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:focus:ring-blue-800 dark:hover:bg-blue-500"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("svg", {
      xmlns: "http://www.w3.org/2000/svg",
      ...
      className: "sr-only"
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__._x)("Export", "SelectControl label", "nortic-plugin"))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
      type: "button",
      className: "text-blue-700 border border-blue-700 hover:bg-blue-700 hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center mr-2 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:focus:ring-blue-800 dark:hover:bg-blue-500"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("svg", {
      xmlns: "http://www.w3.org/2000/svg",
      ...
      className: "sr-only"
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__._x)("Send", "SelectControl label", "nortic-plugin"))))));
  }
});
})();
