...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"nortic-plugin/hero-section","title":"Hero Section","category":"text","description":"Add a custom Hero Section block","keywords":["hero"],"version":"1","textdomain":"nortic-plugin","editorScript":"file:./index.js","attributes":{"width":{"type":"number","default":1200},"height":{"type":"number","default":675},"title":{"type":"string","source":"html","selector":"h1","default":""},"subtitle":{"type":"string","source":"html","selector":"h2","default":""},"content":{"type":"string","source":"html","selector":"p","default":""},"headingColor":{"type":"string","default":"#ffffff"},"textColor":{"type":"string","default":"#ffffff"},"btnText":{"type":"string"},"btnColor":{"type":"string","default":"#ee2a24"},"readMoreText":{"type":"string"},"readMoreColor":{"type":"string","default":"#ffffff"},"imageID":{"type":"number","default":0},"imageAlt":{"type":"string","default":""},"imageUrl":{"type":"string","default":""},"alignment":{"type":"string","default":"center"}},"style":"file:./index.css"}');
...
/* harmony import */ var _main_css__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./main.css */ "./src/blocks/hero/main.css");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_7__.name, {
  ...
  edit(_ref) {
    ...
    const handleHeroImageSelect = img => {
      ...
      if ((0,_wordpress_blob__WEBPACK_IMPORTED_MODULE_4__.isBlobURL)(img.url)) {
        ...
        if (img.sizes) {
          newHeroImageURL = img.sizes.bannerHero ? img.sizes.bannerHero.url : img.sizes.full.url;
          newHeroImageHeight = img.sizes.bannerHero ? img.sizes.bannerHero.height : img.sizes.full.height;
        } else {
        ...
        (0,_wordpress_blob__WEBPACK_IMPORTED_MODULE_4__.revokeBlobURL)(heroImagePreview);
      }
    ...
    const [heroImagePreview, setHeroImagePreview] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(imageUrl);
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, heroImagePreview && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.BlockControls, {
      group: "inline"
      ...
      name: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)("Replace image", "nortic-plugin"),
      mediaId: imageID,
      mediaURL: imageUrl,
      allowedTypes: ["image/png", "image/jpeg"],
      accept: "image/*",
      onError: e => /* eslint-disable */console.error(...oo_tx(`1816843416_173_30_173_46_11`, e)),
      ...
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)("Image settings", "nortic-plugin")
    }, heroImagePreview && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.SelectControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)("Image size", "nortic-plugin"),
      options: getImageSizeOptions(),
      value: imageUrl,
      onChange: handleOnChangeImageSize
    }), heroImagePreview && !(0,_wordpress_blob__WEBPACK_IMPORTED_MODULE_4__.isBlobURL)(heroImagePreview) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.TextareaControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)("Alt text (alternative text)", "nortic-plugin"),
      value: imageAlt,
      onChange: imageAlt => setAttributes({
        imageAlt
      }),
      help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)("Describe the purpose of the image. Leave empty if the image is purely decorative.", "nortic-plugin")
      ...
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)("Color settings", "nortic-plugin"),
      colorSettings: [{
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)("Heading Color", "nortic-plugin"),
        value: headingColor,
        onChange: headingColor => setAttributes({
          headingColor
        })
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)("Text Color", "nortic-plugin"),
        value: textColor,
        onChange: textColor => setAttributes({
          textColor
        })
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)("Button Color", "nortic-plugin"),
        value: btnColor,
        onChange: btnColor => setAttributes({
          btnColor
        })
      }, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)("Link Color", "nortic-plugin"),
        value: readMoreColor,
        onChange: readMoreColor => setAttributes({
          readMoreColor
        })
      }]
    })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", blockProps, (0,_wordpress_blob__WEBPACK_IMPORTED_MODULE_4__.isBlobURL)(imageUrl) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Spinner, null), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      icon: "format-image",
      onSelect: handleHeroImageSelect,
      onError: e => /* eslint-disable */console.error(...oo_tx(`1816843416_261_30_261_46_11`, e)),
      ...
      className: alignment == "center" ? "container mx-auto max-w-3xl py-16" : "container py-16"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: alignment == "center" ? `text-${alignment}` : `text-${alignment} float-${alignment}`
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
      tagName: "h1",
      placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)("Click to add a title", "nortic-plugin"),
      value: title,
      ...
      tagName: "h2",
      placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)("Click to add a subtitle", "nortic-plugin"),
      value: subtitle,
      ...
      placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)("Edit Text", "nortic-plugin"),
      value: btnText,
      ...
      placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)("Add link", "nortic-plugin"),
      value: readMoreText,
  ...
  save(_ref2) {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", blockProps, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    }, btnText && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText.Content, {
      tagName: "span",
      className: "rounded-md px-6 py-4 text-sm font-semibold shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600",
      style: {
        "background-color": btnColor,
      ...
      value: btnText
    }), readMoreText && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText.Content, {
      tagName: "span",
      className: "text-sm font-semibold leading-6",
      style: {
        color: readMoreColor
