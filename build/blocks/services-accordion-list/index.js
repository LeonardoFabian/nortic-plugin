...
/***/ "./src/blocks/services-accordion-list/main.css":
/*!*****************************************************!*\
  !*** ./src/blocks/services-accordion-list/main.css ***!
  \*****************************************************/
...
/***/ "./src/blocks/services-accordion-list/block.json":
/*!*******************************************************!*\
  !*** ./src/blocks/services-accordion-list/block.json ***!
  \*******************************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"nortic-plugin/services-accordion-list","title":"Services Accordion List","category":"text","description":"Add a list of services in accordion","keywords":["servicios","services","summary","detalles","details","accordion"],"version":"1","textdomain":"nortic-plugin","editorScript":"file:./index.js","attributes":{"taxonomy":{"type":"string","default":"service_classification"},"terms":{"type":"array","default":[]}},"style":"file:./index.css","script":"file:./services-accordion.js"}');
...
(() => {
/*!*****************************************************!*\
  !*** ./src/blocks/services-accordion-list/index.js ***!
  \*****************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block.json */ "./src/blocks/services-accordion-list/block.json");
/* harmony import */ var _icons_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../icons.js */ "./src/icons.js");
/* harmony import */ var _main_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./main.css */ "./src/blocks/services-accordion-list/main.css");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_4__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_1__.name, {
  ...
  edit(_ref) {
    ...
    /* eslint-disable */
    console.log(...oo_oo(`2004780182_15_8_15_48_4`, "Entity Context: ", context));

    // get terms by taxonomy
    const serviceClassificationTerms = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_7__.useSelect)(select => {
    ...
    /* eslint-disable */
    console.log(...oo_oo(`2004780182_30_8_30_62_4`, "Terms IDs: ", serviceClassificationTerms));
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
      className: "my-3"
    }, "Este block se renderiza con PHP, y mostrar\xE1 un arcordeon de servicios, dependiendo de la taxonomia donde te encuentres, listadas a continuaci\xF3n:"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "my-3"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("ul", {
      className: "max-w-md space-y-1 text-gray-500 list-disc list-inside dark:text-gray-400"
    }, serviceClassificationTerms?.map((term, i) => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", {
      key: term.id,
