...
/***/ "./src/blocks/dependency-list/main.css":
/*!*********************************************!*\
  !*** ./src/blocks/dependency-list/main.css ***!
  \*********************************************/
...
/***/ "./src/blocks/dependency-list/block.json":
/*!***********************************************!*\
  !*** ./src/blocks/dependency-list/block.json ***!
  \***********************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"nortic-plugin/dependency-list","title":"Dependency List","category":"widgets","description":"Add a list of Dependencies","keywords":["dependency","dependency list","list","place","location","map","dependencies"],"version":"1","textdomain":"nortic-plugin","editorScript":"file:./index.js","attributes":{"title":{"type":"string","default":"Dependencies"},"use_default_title":{"type":"boolean","default":true}},"supports":{"multiple":false},"style":"file:./index.css","usesContext":["postId"]}');
...
(() => {
/*!*********************************************!*\
  !*** ./src/blocks/dependency-list/index.js ***!
  \*********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/blocks/dependency-list/block.json");
/* harmony import */ var _icons_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../icons.js */ "./src/icons.js");
/* harmony import */ var _main_css__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./main.css */ "./src/blocks/dependency-list/main.css");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, {
  ...
  edit(_ref) {
    ...
    /* eslint-disable */
    console.log(...oo_oo(`171127707_24_4_24_33_4`, "postId", postId));
    ...
    /* eslint-disable */
    console.log(...oo_oo(`171127707_56_4_56_45_4`, "Dependencies", dependencies));
    if (!dependencies) {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.PanelBody, {
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Show default title", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain),
      checked: use_default_title,
      onChange: value => setAttributes({
        use_default_title: value
      }),
      help: use_default_title ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Showing title by default", "nortic-plugin") : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Add a custom title", "nortic-plugin")
    }), !use_default_title && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.TextareaControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Title", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain),
      value: title,
      onChange: value => setAttributes({
        title: value
      })
    }))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", blockProps, use_default_title ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h5", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Dependencies", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain)) : (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
      tagName: "h5",
    ...
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("ul", null, dependencies?.length > 0 && dependencies?.map(dependency => {
      /* eslint-disable */console.log(...oo_oo(`171127707_109_16_109_39_4`, dependency));
      const dependencyTitle = dependency?.title?.rendered;
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", {
        key: dependency.id
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
        className: "title"
      }, dependencyTitle), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, "phone"));
    }))));
  },
  save() {
    return null;
