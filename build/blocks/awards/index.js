...
/***/ "./src/blocks/awards/block.json":
/*!**************************************!*\
  !*** ./src/blocks/awards/block.json ***!
  \**************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"nortic-plugin/awards","title":"Awards","category":"text","description":"Shows the recognitions obtained by your website.","keywords":["award","recognition"],"version":"1","textdomain":"nortic-plugin","editorScript":"file:./index.js","attributes":{"categories":{"type":"array","default":[]},"count":{"type":"number","default":10},"orderBy":{"type":"string","default":"title"},"order":{"type":"string","default":"asc"}},"style":"file:./index.css"}');
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/blocks/awards/block.json");
/* harmony import */ var _icons_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../icons.js */ "./src/icons.js");
/* harmony import */ var _main_css__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./main.css */ "./src/blocks/awards/main.css");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, {
  ...
  edit(_ref) {
    ...
    const awardCategories = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.useSelect)(select => {
    ...
    const awards = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.useSelect)(select => {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.PanelBody, {
      ...
      onCategoryChange: newCat => {
        ...
        newCat.forEach(cat => {
          ...
          const awardTerm = awardCategories?.find(term => term.name === cat);
          if (awardTerm) newAwardCategoriesArray.push(awardTerm);
        });
        setAttributes({
          categories: newAwardCategoriesArray
        });
      },
      ...
      title: "Norma sobre Publicaci\xF3n de Datos Abiertos del Gobierno Dominicano.",
      rel: "noopener"
