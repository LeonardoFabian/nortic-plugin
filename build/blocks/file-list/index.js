...
/***/ "./src/blocks/file-list/block.json":
/*!*****************************************!*\
  !*** ./src/blocks/file-list/block.json ***!
  \*****************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"nortic-plugin/file-list","title":"File List","category":"text","description":"Add a list of files","keywords":["document","file","item","pdf","txt","doc","docx","xls","xlsx","ppt","pptx","ods","csv","image","audio","video"],"version":"1","textdomain":"nortic-plugin","editorScript":"file:./index.js","attributes":{"count":{"type":"number","default":10},"directories":{"type":"array","default":[]},"order":{"type":"string","default":"desc"},"orderBy":{"type":"string","default":"date"}},"style":"file:./index.css","script":"file:./frontend-file-list.js"}');
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./block.json */ "./src/blocks/file-list/block.json");
/* harmony import */ var _icons_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../icons.js */ "./src/icons.js");
/* harmony import */ var _main_css__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./main.css */ "./src/blocks/file-list/main.css");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_7__.name, {
  ...
  edit(_ref) {
    ...
    const fileDirectoriesTerms = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.useSelect)(select => {
    ...
    const files = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.useSelect)(select => {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.PanelBody, {
      ...
      onCategoryChange: newTerms => {
        ...
        newTerms.forEach(directory => {
          ...
          const directoryTerm = fileDirectoriesTerms?.find(term => term.name === directory);
      ...
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "relative rounded-xl bg-white border-solid border border-gray-200 py-2 px-4 mb-2 shadow-xl flex justify-between items-center"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("i", {
        className: "bi-info-circle-fill !text-md color-yellow absolute top-0 right-0 p-2"
      }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "file-data py-2 text-gray-500 flex justify-start items-center"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
        className: "dashicons dashicons-media-default file-icon w-14"
      }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "flex flex-col items-start px-4"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h6", {
        className: "text-md font-semibold"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.RawHTML, null, file.title.rendered ? file.title.rendered : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("No Title", "nortic-plugin"))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "flex items-center justify-start gap-4"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
        className: "file-size text-sm"
      }, file.meta.file_size_readable), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Publication date', 'nortic-plugin'), ":", (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("time", {
        dateTime: (0,_wordpress_date__WEBPACK_IMPORTED_MODULE_6__.format)("c", file.date_gmt),
        className: "text-sm text-body-color"
      }, (0,_wordpress_date__WEBPACK_IMPORTED_MODULE_6__.dateI18n)((0,_wordpress_date__WEBPACK_IMPORTED_MODULE_6__.__experimentalGetSettings)().formats.date, file.date_gmt)))))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "file-options gap-4 justify-between"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
        className: "button button-accent",
        href: "#"
      }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Download', 'nortic-plugin'))));
    }))))));
  }
});
})();
