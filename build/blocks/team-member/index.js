...
const Sidebar = _ref => {
  ...
  const [showSidebar, setShowSidebar] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(show);
  const handleShowSidebar = () => {
    setShowSidebar(!showSidebar);
  };

  /* eslint-disable */
  console.log(...oo_oo(`2176325758_10_2_10_26_4`, showSidebar));
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: `top-0 right-0 w-25vw bg-white p-8 mt-10 text-white fixed h-full shadow-lg z-40 ease-in-out duration-300 ${showSidebar ? "translate-x-0" : "translate-x-full"}`
    ...
    className: "mt-10 font-semibold text-slate-700"
  }, "I am a Sidebar")));
};
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"nortic-plugin/team-member","title":"Team Member","category":"text","description":"Add a custom Team Member block","keywords":["team","member"],"version":"1","textdomain":"nortic-plugin","editorScript":"file:./index.js","attributes":{"name":{"type":"string","source":"html","selector":"h4"},"title":{"type":"string","source":"html","selector":"span"},"bio":{"type":"string","source":"html","selector":"p"},"imageID":{"type":"number","default":0},"imageAlt":{"type":"string","default":"","source":"attribute","selector":"img","attribute":"alt"},"imageUrl":{"type":"string","default":"","source":"attribute","selector":"img","attribute":"src"},"files_title":{"type":"string"},"files":{"type":"array","default":[],"source":"query"},"socialHandles":{"type":"array","default":[{"url":"https://facebook.com","icon":"facebook"},{"url":"https://instagram.com","icon":"instagram"},{"url":"https://twitter.com","icon":"twitter"},{"url":"https://linkedin.com","icon":"linkedin"}],"source":"query","selector":".social-media-links a","query":{"url":{"source":"attribute","attribute":"href"},"icon":{"source":"attribute","attribute":"data-icon"}}},"imageShape":{"type":"string","default":"circle"}},"style":"file:./index.css","usesContext":["nortic-plugin/grid-list-image-shape"]}');
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/blocks/team-member/block.json");
...
/* harmony import */ var _components_sidebar_index_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../components/sidebar/index.js */ "./src/components/sidebar/index.js");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, {
  ...
  edit(_ref) {
    ...
    const [showInfo, setShowInfo] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
    const [teamMemberImagePreview, setTeamMemberImagePreview] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(imageUrl);
    ...
    const handleSelectTeamMemberImage = img => {
      ...
      if ((0,_wordpress_blob__WEBPACK_IMPORTED_MODULE_4__.isBlobURL)(img.url)) {
        ...
        newImageURL = img.sizes ? img.sizes.teamMember.url : img.media_details.sizes.teamMember.source_url;
        setAttributes({
          imageID: img.id,
          imageAlt: img.alt,
          imageUrl: newImageURL
        });
        (0,_wordpress_blob__WEBPACK_IMPORTED_MODULE_4__.revokeBlobURL)(teamMemberImagePreview);
      }
    ...
    const handleShowInfo = event => {
      /* eslint-disable */console.log(...oo_oo(`3804486241_87_6_87_24_4`, event));
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, teamMemberImagePreview && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.BlockControls, {
      group: "inline"
      ...
      name: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Replace image", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain),
      mediaId: imageID,
      mediaURL: imageUrl,
      allowedTypes: ["image/png", "image/jpeg", "image/webp"],
      accept: "image/*",
      onError: e => /* eslint-disable */console.error(...oo_tx(`3804486241_111_30_111_46_11`, e)),
    ...
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Remove image", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelBody, {
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Settings", "nortic-plugin")
    }, teamMemberImagePreview && !(0,_wordpress_blob__WEBPACK_IMPORTED_MODULE_4__.isBlobURL)(teamMemberImagePreview) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.TextareaControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Image Alt Attribute", "nortic-plugin"),
      value: imageAlt,
      onChange: imageAlt => setAttributes({
        imageAlt
      }),
      help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Image description for screen readers", "nortic-plugin")
      ...
      className: "sr-only"
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Show info", "nortic-plugin")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("i", {
      class: "bi bi-info-circle"
    }))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "text-center text-gray-500 dark:text-gray-400 team-member-meta"
    }, teamMemberImagePreview && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
      ...
      ,
      onError: e => {
        /* eslint-disable */console.error(...oo_tx(`3804486241_177_18_177_34_11`, e));
      },
      ...
      placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Name", "nortic-plugin"),
      ...
      tagName: "span",
      placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Title", "nortic-plugin"),
      ...
      tagName: "p",
      placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Biography", "nortic-plugin"),
      onChange: bio => setAttributes({
        bio
      }),
      value: bio
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "flex justify-center mt-4 space-x-4 social-media-links"
      ...
      text: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Add Social Media Link", "nortic-plugin")
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("URL", "nortic-plugin"),
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Icon", "nortic-plugin"),
    ...
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Remove", "nortic-plugin"))))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_sidebar_index_js__WEBPACK_IMPORTED_MODULE_9__["default"], {
      show: showInfo
    }));
  },
  save(_ref2) {
