...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"nortic-plugin/carousel","title":"Carousel","category":"text","description":"","keywords":["carousel"],"version":"1","textdomain":"nortic-plugin","editorScript":"file:./index.js","attributes":{"textColor":{"type":"string","default":"#ffffff"},"btnColor":{"type":"string","default":"#003876"},"count":{"type":"number","default":5},"categories":{"type":"array","default":[]},"order":{"type":"string","default":"desc"},"orderBy":{"type":"string","default":"date"},"show_the_excerpt":{"type":"boolean","default":false}},"style":"file:./index.css","script":"file:./frontend-carousel.js"}');
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./block.json */ "./src/blocks/carousel/block.json");
/* harmony import */ var _icons_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../icons.js */ "./src/icons.js");
/* harmony import */ var _main_css__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./main.css */ "./src/blocks/carousel/main.css");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_7__.name, {
  ...
  edit(_ref) {
    ...
    const carouselPosts = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.useSelect)(select => {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.PanelBody, {
      ...
      onCategoryChange: newTerms => {
        ...
        newTerms.forEach(cat => {
          ...
          const postCategoriesTerms = postCategories?.find(term => term.name === cat);
          if (postCategoriesTerms) newPostCategories.push(postCategoriesTerms);
        });
        setAttributes({
      ...
      onChange: show_the_excerpt => setAttributes({
        show_the_excerpt
      }),
      help: show_the_excerpt ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Showing the excerpt", "nortic-plugin") : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Hiding the excerpt", "nortic-plugin")
      ...
      const postFeaturedImage = post._embedded && post._embedded["wp:featuredmedia"] && post._embedded["wp:featuredmedia"].length > 0 && post._embedded["wp:featuredmedia"][0];
      const date = (0,_wordpress_date__WEBPACK_IMPORTED_MODULE_6__.dateI18n)("F j, Y", post.date);
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "h-96 glide__slide"
      }, postFeaturedImage && postFeaturedImage.media_details.sizes.bannerHero && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        ...
        className: "carousel_content absolute bottom-0 flex flex-col justify-end w-screen pb-10 cursor-pointer"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "container"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h5", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("The Post Title will be displayed here on the frontend", "nortic-plugin")), show_the_excerpt && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
        className: "carousel-content-excerpt"
      }, "Lorem ipsum dolor sit amet, consectetur adipscing elit. Praesent mi tortor, vehicula et porta vel, aliquam eu est."), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
        href: "javascript:void(0)",
        className: "wp-block-button__link wp-element-button"
      }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Read more", "nortic-plugin"))))));
    })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    }, carouselPosts?.map((bullets, index) => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
      type: "button",
      ...
      class: "bi bi-arrow-left text-md"
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
      className: "sr-only"
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Previous", "nortic-plugin")))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
      type: "button",
      ...
      class: "bi bi-arrow-right text-md"
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
      className: "sr-only"
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Next", "nortic-plugin"))))));
  }
});
})();
