...
/***/ "./src/blocks/documents-directory/main.css":
/*!*************************************************!*\
  !*** ./src/blocks/documents-directory/main.css ***!
  \*************************************************/
...
/***/ "./src/blocks/documents-directory/block.json":
/*!***************************************************!*\
  !*** ./src/blocks/documents-directory/block.json ***!
  \***************************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"nortic-plugin/documents-directory","title":"Documents directory","category":"widgets","description":"Display a directory taxonomy list of documents","keywords":["documents directory","directorio de documentos","directory","directorio","documents","documentos"],"version":"1","textdomain":"nortic-plugin","editorScript":"file:./index.js","attributes":{"order":{"type":"string","default":"asc"},"orderBy":{"type":"string","default":"title"}},"supports":{"multiple":false},"style":"file:./index.css"}');
...
(() => {
/*!*************************************************!*\
  !*** ./src/blocks/documents-directory/index.js ***!
  \*************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/blocks/documents-directory/block.json");
/* harmony import */ var _icons_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../icons.js */ "./src/icons.js");
/* harmony import */ var _main_css__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./main.css */ "./src/blocks/documents-directory/main.css");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, {
  ...
  edit(_ref) {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, "Este block se renderiza en el frontend");
  }
});
})();
