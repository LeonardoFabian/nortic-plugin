...
/***/ "./src/blocks/service-summary/main.css":
/*!*********************************************!*\
  !*** ./src/blocks/service-summary/main.css ***!
  \*********************************************/
...
/***/ "./src/blocks/service-summary/block.json":
/*!***********************************************!*\
  !*** ./src/blocks/service-summary/block.json ***!
  \***********************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"nortic-plugin/service-summary","title":"Service Summary","category":"text","description":"Add a summary section for a service","keywords":["servicio","service","summary","detalles","details"],"version":"1","textdomain":"nortic-plugin","editorScript":"file:./index.js","attributes":{"hours":{"type":"string"},"cost":{"type":"string"},"completion_time":{"type":"string"},"online_service_url":{"type":"string"},"icon_color":{"type":"string","default":"#003876"}},"style":"file:./index.css","usesContext":["postId"]}');
...
(() => {
/*!*********************************************!*\
  !*** ./src/blocks/service-summary/index.js ***!
  \*********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/blocks/service-summary/block.json");
/* harmony import */ var _icons_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../icons.js */ "./src/icons.js");
/* harmony import */ var _main_css__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./main.css */ "./src/blocks/service-summary/main.css");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, {
  ...
  edit(_ref) {
    ...
    const [classificationTermsIDs] = (0,_wordpress_core_data__WEBPACK_IMPORTED_MODULE_3__.useEntityProp)("postType", "service", "service_classification", postId);
    ...
    const {
      ...
      return {
        classifications: getEntityRecords("taxonomy", "service_classification", {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", blockProps, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "service-summary-card mb-4 flex-1 p-8 cursor-pointer border border-gray-200 rounded-lg shadow-lg  bg-white"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "block relative text-center max-w-xs overflow-hidden  bg-cover bg-no-repeat h-full"
      ...
      className: "service-summary-title"
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Schedule and place of provision", "nortic-plugin")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
      tagName: "span",
      value: hours,
      onChange: hours => setAttributes({
        hours
      }),
      placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Click to edit", "nortic-plugin")
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "absolute"
      ...
      className: "service-summary-title"
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Completion time", "nortic-plugin")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
      tagName: "span",
      value: completion_time,
      onChange: completion_time => setAttributes({
        completion_time
      }),
      placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Click to edit", "nortic-plugin")
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      className: "text-white"
    }, completion_time)))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "service-summary-card mb-4 flex-1 p-8 cursor-pointer border border-gray-200 rounded-lg shadow-lg  bg-white"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "block relative text-center max-w-xs overflow-hidden  bg-cover bg-no-repeat h-full"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("i", {
      ...
      className: "service-summary-title"
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Cost", "nortic-plugin")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
      tagName: "span",
      value: cost,
      onChange: cost => setAttributes({
        cost
      }),
      placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Click to edit", "nortic-plugin")
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      className: "text-white"
    }, cost)))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "service-summary-card mb-4 flex-1 p-8 cursor-pointer border border-gray-200 rounded-lg shadow-lg  bg-white"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "block relative text-center max-w-xs overflow-hidden  bg-cover bg-no-repeat h-full"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("i", {
      ...
      className: "service-summary-title"
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Link", "nortic-plugin")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
      tagName: "span",
      value: online_service_url,
      onChange: online_service_url => setAttributes({
        online_service_url
      }),
      placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Click to edit", "nortic-plugin")
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
