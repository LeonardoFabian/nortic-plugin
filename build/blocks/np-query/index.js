...
/***/ "./src/blocks/np-query/block.json":
/*!****************************************!*\
  !*** ./src/blocks/np-query/block.json ***!
  \****************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"nortic-plugin/np-query","title":"NP Query Loop","category":"widgets","description":"An advanced block that allows displaying Nortic Plugin post types based on different query parameters and visual configurations.","keywords":["query","posts"],"version":"1","textdomain":"nortic-plugin","editorScript":"file:./index.js","attributes":{"queryId":{"type":"number"},"query":{"type":"object","default":{"perPage":null,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":true,"taxQuery":null,"parents":[]}},"tagName":{"type":"string","default":"div"},"displayLayout":{"type":"object","default":{"type":"list"}},"namespace":{"type":"string"},"columns":{"type":"number","default":3},"numberOfPosts":{"type":"number","default":3},"categories":{"type":"array","default":[]},"taxonomies":{"type":"array","default":[]},"order":{"type":"string","default":"desc"},"orderBy":{"type":"string","default":"date"},"displayFeaturedImage":{"type":"boolean","default":true},"displayDate":{"type":"boolean","default":true}},"providesContext":{"nortic-plugin/np-query-id":"queryId","nortic-plugin/np-query":"query","nortic-plugin/display-layout":"displayLayout"},"supports":{"align":["wide","full"],"html":false,"color":{"gradients":true,"link":true,"__experimentalDefaultControls":{"background":true,"text":true}},"__experimentalLayout":true},"editorStyle":"file:./editor.css","style":"file:./index.css"}');
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./block.json */ "./src/blocks/np-query/block.json");
/* harmony import */ var _icons_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../icons.js */ "./src/icons.js");
/* harmony import */ var _main_css__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./main.css */ "./src/blocks/np-query/main.css");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_5__.name, {
  ...
  edit(_ref) {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelBody, {
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__._x)("Settings", "PanelBody title", "nortic-plugin")
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.RangeControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__._x)("Number of Posts", "RangeControl label", "nortic-plugin"),
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__._x)("Columns", "RangeControl label", "nortic-plugin"),
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__._x)("Show Featured Image", "ToggleControl label", "nortic-plugin"),
      checked: displayFeaturedImage,
      onChange: displayFeaturedImage => setAttributes({
        displayFeaturedImage
      }),
      help: displayFeaturedImage ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Featured Image viewable", "nortic-plugin") : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Hidden Featured Image", "nortic-plugin")
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.ToggleControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__._x)("Show Date", "ToggleControl label", "nortic-plugin"),
      checked: displayDate,
      onChange: displayDate => setAttributes({
        displayDate
      }),
      help: displayFeaturedImage ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Date viewable", "nortic-plugin") : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Hidden Date", "nortic-plugin")
