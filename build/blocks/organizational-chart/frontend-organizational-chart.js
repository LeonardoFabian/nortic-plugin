...
"use strict";
/*!**************************************************************************!*\
  !*** ./src/blocks/organizational-chart/frontend-organizational-chart.js ***!
  \**************************************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react_dom_client__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react-dom/client */ "./node_modules/react-dom/client.js");
/* harmony import */ var react_organizational_chart__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! react-organizational-chart */ "./node_modules/react-organizational-chart/dist/index.module.js");
...
const StyledNode = styled_components__WEBPACK_IMPORTED_MODULE_4__["default"].div`
  padding: 5px 10px;
  border-radius: 8px;
...
const ModalOverlay = styled_components__WEBPACK_IMPORTED_MODULE_4__["default"].div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
  ...
  z-index: 999;
`;
const ModalContent = styled_components__WEBPACK_IMPORTED_MODULE_4__["default"].div`
  position: fixed;
  top: 50%;
  left: 50%;
  width: 90%;
  ...
  border-radius: 10px;
`;
function OrganizationalChart(_ref) {
  let {
    treeData
  } = _ref;
  ...
  const renderNode = node => {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_organizational_chart__WEBPACK_IMPORTED_MODULE_3__.TreeNode, {
      label: (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(StyledNode, {
        onClick: () => setActiveNode(node)
      }, node.title),
      key: node.id
    }, children.map(renderNode));
  };
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_organizational_chart__WEBPACK_IMPORTED_MODULE_3__.Tree, {
    label: (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(StyledNode, {
      onClick: () => setActiveNode(treeData)
    }, treeData.title)
  }, (Array.isArray(treeData.children) ? treeData.children : []).map(renderNode)), activeNode && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(ModalOverlay, {
    onClick: () => setActiveNode(null)
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(ModalContent, {
    onClick: e => e.stopPropagation()
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h2", null, activeNode.title), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    dangerouslySetInnerHTML: {
      __html: activeNode.content || ""
    }
...
window.addEventListener("DOMContentLoaded", () => {
  const container = document.querySelector(".wp-block-nortic-plugin-organizational-chart");
  if (!container) return;
  ...
  try {
    ...
    /* eslint-disable */console.error(...oo_tx(`455760772_122_4_122_52_11`, "Error parsing tree data:", error));
    return;
  }
  const root = (0,react_dom_client__WEBPACK_IMPORTED_MODULE_2__.createRoot)(container);
  root.render((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(OrganizationalChart, {
    treeData: treeData
  }));
  // root.render(
...
/******/ })()
;
//# sourceMappingURL=frontend-organizational-chart.js.map