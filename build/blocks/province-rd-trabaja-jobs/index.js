...
/***/ "./src/blocks/province-rd-trabaja-jobs/main.css":
/*!******************************************************!*\
  !*** ./src/blocks/province-rd-trabaja-jobs/main.css ***!
  \******************************************************/
...
/***/ "./src/blocks/province-rd-trabaja-jobs/block.json":
/*!********************************************************!*\
  !*** ./src/blocks/province-rd-trabaja-jobs/block.json ***!
  \********************************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"nortic-plugin/province-rd-trabaja-jobs","title":"Province RD-Trabaja Jobs","category":"widgets","description":"Add a list of jobs published by RD-Trabaja in a given province","keywords":["province","jobs","vacant","vacancies","rd-trabaja","api"],"version":"1","textdomain":"nortic-plugin","editorScript":"file:./index.js","attributes":{"landing_page_heading":{"type":"string","default":"¡Tu próxima oportunidad laboral puede estar aquí!"},"landing_page_subheading":{"type":"string","default":"Explora las vacantes que tenemos para ti en nuestro sistema de intermediación laboral del programa RD-Trabaja y encuentra el empleo que mejor se adapte a ti. ¡No pierdas más tiempo, comienza ahora!"},"heading":{"type":"string","default":"¡Tu próximo empleo puede estar en esta provincia! "},"subheading":{"type":"string","default":"Descubre las vacantes publicadas en nuestro sistema de intermediación laboral y aprovecha las oportunidades que tenemos en tu provincia. ¡Consulta el listado ahora!"},"title":{"type":"string","default":"Vacantes publicadas recientemente"},"view_more_link":{"type":"string"}},"supports":{"multiple":false},"style":"file:./index.css","usesContext":["taxonomyId"]}');
...
(() => {
/*!******************************************************!*\
  !*** ./src/blocks/province-rd-trabaja-jobs/index.js ***!
  \******************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/blocks/province-rd-trabaja-jobs/block.json");
/* harmony import */ var _icons_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../icons.js */ "./src/icons.js");
/* harmony import */ var _main_css__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./main.css */ "./src/blocks/province-rd-trabaja-jobs/main.css");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, {
  ...
  edit(_ref) {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.PanelBody, {
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Landing Page Heading", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain),
      value: landing_page_heading,
      onChange: value => setAttributes({
        landing_page_heading: value
      })
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.TextareaControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Landing Page Subheading", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain),
      value: landing_page_subheading,
      onChange: value => setAttributes({
        landing_page_subheading: value
      })
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.TextareaControl, {
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("View More Link", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain),
      value: view_more_link,
      onChange: value => setAttributes({
        view_more_link: value
      })
      ...
      className: "wp-block-nortic-plugin-province-rd-trabaja-jobs-cta"
      ...
      help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("This heading will be displayed when the block is used on the landing page", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain)
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
      tagName: "h4",
      value: landing_page_subheading,
      onChange: value => setAttributes({
      ...
      help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("This subheading will be displayed when the block is used on the landing page", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain)
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
      tagName: "h2",
      value: heading,
      onChange: value => setAttributes({
      ...
      help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("This heading will be displayed when the block is used in a province", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain)
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
      tagName: "h4",
      value: subheading,
      onChange: value => setAttributes({
      ...
      help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("This subheading will be displayed when the block is used in a province", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain)
    })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "wp-block-nortic-plugin-province-rd-trabaja-jobs-list-header"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
      tagName: "h5",
      value: title,
      onChange: value => setAttributes({
      ...
      className: "jobs-platform-link"
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("View more", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("ul", {
      className: "wp-block-nortic-plugin-province-rd-trabaja-jobs-list"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", {
      className: "wp-block-nortic-plugin-province-rd-trabaja-jobs-list-item"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "wp-block-nortic-plugin-province-rd-trabaja-jobs-list-item-header"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h5", null, "Lorem ipsum dolor sit amet"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("time", {
      datetime: job_published_at_iso
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Published at", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain), " ", (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, job_published_at_formatted))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      class: "wp-block-nortic-plugin-province-rd-trabaja-jobs-list-item-body"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, "Lorem ipsum dolor sit amet consectetur adipisicing elit."))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", {
      className: "wp-block-nortic-plugin-province-rd-trabaja-jobs-list-item"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "wp-block-nortic-plugin-province-rd-trabaja-jobs-list-item-header"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h5", null, "Lorem ipsum dolor sit amet"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("time", {
      ...
      class: "wp-block-nortic-plugin-province-rd-trabaja-jobs-list-item-body"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, "Lorem ipsum dolor sit amet consectetur adipisicing elit."))))));
  }
});
})();
