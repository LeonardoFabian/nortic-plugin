...
/***/ "./src/blocks/hero-blank/main.css":
/*!****************************************!*\
  !*** ./src/blocks/hero-blank/main.css ***!
  \****************************************/
...
/***/ "./src/blocks/hero-blank/block.json":
/*!******************************************!*\
  !*** ./src/blocks/hero-blank/block.json ***!
  \******************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"nortic-plugin/hero-blank","title":"Hero Blank Template","category":"text","description":"Add a custom Hero Blank Template block","keywords":["hero","blank"],"version":"1","textdomain":"nortic-plugin","editorScript":"file:./index.js","attributes":{"width":{"type":"number","default":1200},"height":{"type":"number","default":675},"imageID":{"type":"number","default":0},"imageAlt":{"type":"string","default":""},"imageUrl":{"type":"string","default":""}},"style":"file:./index.css"}');
...
(() => {
/*!****************************************!*\
  !*** ./src/blocks/hero-blank/index.js ***!
  \****************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/blocks/hero-blank/block.json");
/* harmony import */ var _icons_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../icons.js */ "./src/icons.js");
/* harmony import */ var _main_css__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./main.css */ "./src/blocks/hero-blank/main.css");
  ...
  edit(_ref) {
    ...
    const handleHeroBlankImageSelect = image => {
      ...
      if ((0,_wordpress_blob__WEBPACK_IMPORTED_MODULE_3__.isBlobURL)(image.url)) {
        ...
        if (image.sizes) {
          newHeroBlankImageURL = image.sizes.bannerHero ? image.sizes.bannerHero.url : image.sizes.full.url;
          newHeroBlankImageHeight = image.sizes.bannerHero ? image.sizes.bannerHero.height : image.sizes.full.height;
        } else {
          newHeroBlankImageURL = image.media_details.sizes.bannerHero.source_url;
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, heroBlankImagePreview && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.BlockControls, {
      ...
      accept: "image/*",
      onError: e => /* eslint-disable */console.error(...oo_tx(`1114350051_83_30_83_46_11`, e)),
    ...
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Remove image", "nortic-plugin"))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", blockProps, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      className: "hero-blank__content container"
      ...
      icon: "format-image",
      onSelect: handleHeroBlankImageSelect,
      onError: e => /* eslint-disable */console.error(...oo_tx(`1114350051_129_26_129_42_11`, e)),
