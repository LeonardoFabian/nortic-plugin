...
/***/ "./src/blocks/team-list/block.json":
/*!*****************************************!*\
  !*** ./src/blocks/team-list/block.json ***!
  \*****************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"nortic-plugin/team-list","title":"Team List","category":"widgets","description":"Add a list of Team Members","keywords":["team","team list","list","member","members","group","team member","team members"],"version":"1","textdomain":"nortic-plugin","editorScript":"file:./index.js","attributes":{"group_terms":{"type":"array","default":[]},"numberOfItems":{"type":"number","default":100},"order":{"type":"string","default":"asc"},"orderBy":{"type":"string","default":"title"},"show_navigation_thumbs":{"type":"boolean","default":true}},"supports":{"multiple":false},"style":"file:./index.css","script":"file:./team-list-frontend.js"}');
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/blocks/team-list/block.json");
/* harmony import */ var _icons_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../icons.js */ "./src/icons.js");
/* harmony import */ var _main_css__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./main.css */ "./src/blocks/team-list/main.css");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, {
  ...
  edit(_ref) {
    ...
    /* eslint-disable */
    console.log(...oo_oo(`3185076496_30_4_30_39_4`, "Terms: ", group_terms));
    const groupTermsQuery = {
      per_page: -1
    };

    // retrieve team tags
    const groupTerms = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(select => {
      return select("core").getEntityRecords("taxonomy", "group", groupTermsQuery);
    }, []);
    ...
    const teams = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(select => {
      const query = {
    ...
    /* eslint-disable */
    console.log(...oo_oo(`3185076496_82_4_82_33_4`, "teams: ", teams));
    const handleShowNavigationThumbs = () => {
      setAttributes({
        show_navigation_thumbs: !show_navigation_thumbs
      });
    };
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.PanelBody, {
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Show Navigation Thumbs", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain),
      checked: show_navigation_thumbs,
      onChange: handleShowNavigationThumbs,
      helpText: show_navigation_thumbs ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Displaying thumbnail images", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain) : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Hiding thumbnail images", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain)
      ...
      minItems: -1,
      maxItems: 100,
      onNumberOfItemsChange: numberOfItems => setAttributes({
        numberOfItems
      }),
      ...
      onCategoryChange: newTerms => {
        ...
        newTerms.forEach(group => {
          ...
          const groupTerm = groupTerms?.find(term => term.name === group);
          if (groupTerm) newGroups.push(groupTerm);
        });
        setAttributes({
          group_terms: newGroups
        });
      },
    ...
    }))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", blockProps, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("ul", {
      className: `team-list-wrapper`
    }, teams?.length > 0 ? teams?.map(team => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", {
      key: team?.id,
      ...
      className: "team-list-item-title"
    }, team?.title?.rendered)))) : (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("No teams available", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain)))));
  }
});
