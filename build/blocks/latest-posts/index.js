...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"nortic-plugin/nortic-latest-posts","title":"Latest Posts","category":"text","description":"Add a list of latest posts","keywords":["posts"],"version":"1","textdomain":"nortic-plugin","editorScript":"file:./index.js","attributes":{"title":{"type":"string","default":""},"description":{"type":"string","default":""},"columns":{"type":"number","default":4},"count":{"type":"number","default":3},"categories":{"type":"array","default":[]},"tags":{"type":"array","default":[]},"displayFeaturedImage":{"type":"boolean","default":true},"displayViewMoreButton":{"type":"boolean","default":false},"order":{"type":"string","default":"desc"},"orderBy":{"type":"string","default":"date"},"useTemplateQuery":{"type":"boolean","default":false}},"style":"file:./index.css"}');
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./block.json */ "./src/blocks/latest-posts/block.json");
/* harmony import */ var _icons_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../icons.js */ "./src/icons.js");
/* harmony import */ var _main_css__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./main.css */ "./src/blocks/latest-posts/main.css");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_7__.name, {
  ...
  edit(_ref) {
    ...
    const postCategoriesTerms = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.useSelect)(select => {
    ...
    const postTagsTerms = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.useSelect)(select => {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.PanelBody, {
      ...
      onCategoryChange: newTerms => {
        ...
        newTerms.forEach(cat => {
          ...
          const categoryTerm = postCategoriesTerms?.find(term => term.name === cat);
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Columns", "nortic-plugin"),
      ...
      min: 1,
      max: 5,
      help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Number of columns in which the posts will be displayed", _block_json__WEBPACK_IMPORTED_MODULE_7__.textdomain)
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.ToggleControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Show Featured Image", _block_json__WEBPACK_IMPORTED_MODULE_7__.textdomain),
      checked: displayFeaturedImage,
      onChange: displayFeaturedImage => setAttributes({
        displayFeaturedImage
      }),
      help: displayFeaturedImage ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Featured Image viewable", _block_json__WEBPACK_IMPORTED_MODULE_7__.textdomain) : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Hidden Featured Image", _block_json__WEBPACK_IMPORTED_MODULE_7__.textdomain)
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.ToggleControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Display view more button", _block_json__WEBPACK_IMPORTED_MODULE_7__.textdomain),
      checked: displayViewMoreButton,
      onChange: displayViewMoreButton => setAttributes({
        displayViewMoreButton
      }),
      help: displayViewMoreButton ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("View more button is visible", _block_json__WEBPACK_IMPORTED_MODULE_7__.textdomain) : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("View more button is hidden", _block_json__WEBPACK_IMPORTED_MODULE_7__.textdomain)
      ...
      tagName: "h2",
      className: "\r font-bold\r text-3xl                  \r text-dark\r mb-4\r ",
      value: title,
      onChange: title => setAttributes({
        title
      }),
      placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Add a title", _block_json__WEBPACK_IMPORTED_MODULE_7__.textdomain)
    })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "text-center mx-auto"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
      tagName: "p",
      ...
      placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Add description", _block_json__WEBPACK_IMPORTED_MODULE_7__.textdomain)
    })))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "flex flex-wrap -mx-4 latest-post-container"
    }, posts?.map(post => {
      ...
      const postDate = (0,_wordpress_date__WEBPACK_IMPORTED_MODULE_6__.dateI18n)((0,_wordpress_date__WEBPACK_IMPORTED_MODULE_6__.__experimentalGetSettings)().formats.date, post.date_gmt);
      ...
      }, displayFeaturedImage && featuredImage && featuredImage.media_details.sizes.landscape && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
        className: "nortic-plugin__single_post--image",
        href: post.link
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
        src: featuredImage.media_details.sizes.landscape.source_url,
        alt: featuredImage?.alt_text
      }))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, post.title.rendered && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h3", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
        href: post.link,
        className: "\r font-semibold\r text-xl                        \r mb-4\r inline-block\r text-dark"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.RawHTML, null, post.title.rendered))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("time", {
