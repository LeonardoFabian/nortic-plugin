...
/***/ "./src/blocks/service-list/main.css":
/*!******************************************!*\
  !*** ./src/blocks/service-list/main.css ***!
  \******************************************/
...
/***/ "./src/blocks/service-list/block.json":
/*!********************************************!*\
  !*** ./src/blocks/service-list/block.json ***!
  \********************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"nortic-plugin/service-list","title":"Service List","category":"widgets","description":"Add a list of Services","keywords":["service","service list","list","portfolio","servicios","listado de servicios"],"version":"1","textdomain":"nortic-plugin","editorScript":"file:./index.js","attributes":{"heading":{"type":"string"},"subHeading":{"type":"string"},"use_default_title":{"type":"boolean","default":true},"columns":{"type":"number","default":3},"filter_by_tags":{"type":"boolean","default":false},"service_tags":{"type":"array","default":[]},"numberOfItems":{"type":"number","default":50}},"supports":{"multiple":false},"style":"file:./index.css","usesContext":["postId"]}');
...
(() => {
/*!******************************************!*\
  !*** ./src/blocks/service-list/index.js ***!
  \******************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/blocks/service-list/block.json");
/* harmony import */ var _icons_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../icons.js */ "./src/icons.js");
/* harmony import */ var _main_css__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./main.css */ "./src/blocks/service-list/main.css");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, {
  ...
  edit(_ref) {
    ...
    /* eslint-disable */
    console.log(...oo_oo(`203078363_33_4_33_47_4`, "Service Tags: ", service_tags));
    let listClasses = `grid-cols-${columns}`;
    const currentPostType = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(select => select("core/editor").getCurrentPostType(), [postId]);
    const serviceTagsQuery = {
      per_page: -1
    };

    // retrieve service tags
    const serviceTags = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(select => {
      return select("core").getEntityRecords("taxonomy", "service_tag", serviceTagsQuery);
    }, []);
    ...
    if (!!serviceTags) {
      Object.values(serviceTags).forEach(tag => {
        serviceTagOptions.push({
          value: tag?.id,
          label: tag?.name ? tag.name : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("No title", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain)
        });
      });
    } else {
      serviceTagOptions.push({
        value: 0,
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Loading", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain)
      });
    }
    let services = {};
    if (currentPostType === "dependency") {
      // if current post type is a dependency, list dependency services
      services = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(select => {
        const query = {
    ...
    if (!services) {
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", blockProps, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.Spinner, null));
    }

    /* eslint-disable */
    console.log(...oo_oo(`203078363_120_4_120_39_4`, "Services: ", services));
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.PanelBody, {
      ...
      labe: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Number of items", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain),
      value: numberOfItems,
      onChange: handleNumberOfItemsChange,
      min: 1,
      max: 100
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.RangeControl, {
      labe: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Columns to display", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain),
      value: columns,
      onChange: handleChangeColumns,
      min: 1,
      max: 3
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.ToggleControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Show default heading", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain),
      checked: use_default_title,
      onChange: use_default_title => setAttributes({
        use_default_title
      }),
      help: use_default_title ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Showing title by default", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain) : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Add a custom title", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain)
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.ToggleControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Filter by Tags", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain),
      checked: filter_by_tags,
      onChange: handleFilterByTags,
      help: filter_by_tags ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Filtering and grouping services by tag", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain) : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Showing a list of all services", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain)
    }), filter_by_tags && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.SelectControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Filter by tags", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain),
      ...
      help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Ctrl + click to deselect a selection", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain)
    })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.PanelBody, {
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Information", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain)
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Heading", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain),
      value: heading,
      onChange: handleChangeHeading
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.TextareaControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Subheading", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain),
      value: subHeading,
      onChange: handleChangeSubHeading
    }))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", blockProps, use_default_title ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h5", {
      className: "service-list-heading"
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Services", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain)) : (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.RichText, {
      tagName: "h5",
      className: "service-list-heading",
      placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Click to add a title", _block_json__WEBPACK_IMPORTED_MODULE_6__.textdomain),
      value: heading,
      onChange: handleChangeHeading,
      ...
      className: "service-list-subheading"
    }, subHeading), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("ul", {
      className: `service-list-wrapper ${listClasses}`
    }, services?.map(service => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", {
      key: service?.id,
      ...
      className: "service-list-item-title"
