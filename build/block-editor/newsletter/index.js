...
/***/ "./src/block-editor/newsletter/sidebar.js":
/*!************************************************!*\
  !*** ./src/block-editor/newsletter/sidebar.js ***!
  \************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
(0,_wordpress_plugins__WEBPACK_IMPORTED_MODULE_1__.registerPlugin)("nortic-plugin-sidebar", {
  render() {
    ...
    if (!!dependencies) {
      Object.values(dependencies).forEach(dependency => {
        dependencyOptions.push({
          value: dependency?.id,
          label: dependency?.title?.rendered ? dependency.title.rendered : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("No title", "nortic-plugin")
        });
      });
    }
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_edit_post__WEBPACK_IMPORTED_MODULE_2__.PluginSidebar, {
      ...
      icon: "menu-alt",
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Newsletter Metadata", "nortic-plugin")
      ...
      onChange: dependency_id => editPost({
        meta: {
          dependency_id
        }
      })
...
"use strict";
/*!**********************************************!*\
  !*** ./src/block-editor/newsletter/index.js ***!
  \**********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _sidebar_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sidebar.js */ "./src/block-editor/newsletter/sidebar.js");
